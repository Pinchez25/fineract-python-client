...
from fineract_client.apis.loan_charges_api import LoanChargesApi  # noqa: E501
...
class TestLoanChargesApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = LoanChargesApi()  # noqa: E501

    def tearDown(self):
        pass

    def test_delete_loan_charge(self):
    ...
    def test_delete_loan_charge1(self):
    ...
    def test_delete_loan_charge2(self):
    ...
    def test_delete_loan_charge3(self):
    ...
    def test_execute_loan_charge(self):
    ...
    def test_execute_loan_charge1(self):
    ...
    def test_execute_loan_charge2(self):
    ...
    def test_execute_loan_charge3(self):
    ...
    def test_execute_loan_charge4(self):
    ...
    def test_execute_loan_charge5(self):
    ...
    def test_retrieve_all_loan_charges(self):
    ...
    def test_retrieve_all_loan_charges1(self):
    ...
    def test_retrieve_loan_charge(self):
    ...
    def test_retrieve_loan_charge1(self):
    ...
    def test_retrieve_loan_charge2(self):
    ...
    def test_retrieve_loan_charge3(self):
    ...
    def test_retrieve_template8(self):
    ...
    def test_retrieve_template9(self):
    ...
    def test_update_loan_charge(self):
    ...
    def test_update_loan_charge1(self):
    ...
    def test_update_loan_charge2(self):
    ...
    def test_update_loan_charge3(self):
