...
class BodyPart(object):
    ...
    def __init__(self, content_disposition=None, entity=None, headers=None, media_type=None, message_body_workers=None, parameterized_headers=None, parent=None, providers=None):  # noqa: E501
