...
class ContentDisposition(object):
    ...
    def __init__(self, creation_date=None, file_name=None, modification_date=None, parameters=None, read_date=None, size=None, type=None):  # noqa: E501
        """ContentDisposition - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ContentDisposition, dict):
