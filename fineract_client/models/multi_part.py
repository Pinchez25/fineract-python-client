...
class MultiPart(object):
    ...
    def __init__(self, body_parts=None, content_disposition=None, entity=None, headers=None, media_type=None, message_body_workers=None, parameterized_headers=None, parent=None, providers=None):  # noqa: E501
