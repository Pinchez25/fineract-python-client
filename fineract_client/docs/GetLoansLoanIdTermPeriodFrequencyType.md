...
get_loans_loan_id_term_period_frequency_type_from_dict = GetLoansLoanIdTermPeriodFrequencyType.from_dict(get_loans_loan_id_term_period_frequency_type_dict)
```
