...
class TestGetLoanProductsAssetAccountOptions(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetLoanProductsAssetAccountOptions:
        """Test GetLoanProductsAssetAccountOptions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLoanProductsAssetAccountOptions`
        """
        model = GetLoanProductsAssetAccountOptions()
        if include_optional:
            return GetLoanProductsAssetAccountOptions(
                disabled = False,
                gl_code = '02',
                id = 2,
