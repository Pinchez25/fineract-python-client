...
class TestGetAccountTransfersTimeline(unittest.TestCase):
    """GetAccountTransfersTimeline unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAccountTransfersTimeline:
        """Test GetAccountTransfersTimeline
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAccountTransfersTimeline`
        """
        model = GetAccountTransfersTimeline()
        if include_optional:
            return GetAccountTransfersTimeline(
    ...
    def testGetAccountTransfersTimeline(self):
        """Test GetAccountTransfersTimeline"""
