...
class TestGetSavingsProductsLiabilityAccountOptions(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetSavingsProductsLiabilityAccountOptions:
        """Test GetSavingsProductsLiabilityAccountOptions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSavingsProductsLiabilityAccountOptions`
        """
        model = GetSavingsProductsLiabilityAccountOptions()
        if include_optional:
            return GetSavingsProductsLiabilityAccountOptions(
                disabled = False,
                gl_code = '50001',
                id = 15,
