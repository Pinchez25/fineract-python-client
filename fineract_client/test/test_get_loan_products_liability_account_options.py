...
class TestGetLoanProductsLiabilityAccountOptions(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetLoanProductsLiabilityAccountOptions:
        """Test GetLoanProductsLiabilityAccountOptions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLoanProductsLiabilityAccountOptions`
        """
        model = GetLoanProductsLiabilityAccountOptions()
        if include_optional:
            return GetLoanProductsLiabilityAccountOptions(
                disabled = False,
                gl_code = '13',
                id = 11,
