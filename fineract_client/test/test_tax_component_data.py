...
class TestTaxComponentData(unittest.TestCase):
    """TaxComponentData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaxComponentData:
        """Test TaxComponentData
        ...
        if include_optional:
            return TaxComponentData(
                ...
                credit_account_type = fineract_client.models.enum_option_data.EnumOptionData(
                    code = '', 
                    id = 56, 
                    value = '', ),
                debit_account = fineract_client.models.gl_account_data.GLAccountData(
                    account_type_options = [
                        fineract_client.models.enum_option_data.EnumOptionData(
                            code = '', 
                            id = 56, 
                ...
                debit_account_type = fineract_client.models.enum_option_data.EnumOptionData(
                    code = '', 
                    id = 56, 
                    value = '', ),
                gl_account_options = {
