...
class TestJournalEntryData(unittest.TestCase):
    """JournalEntryData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JournalEntryData:
        """Test JournalEntryData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JournalEntryData`
        """
        model = JournalEntryData()
        if include_optional:
            return JournalEntryData(
                ...
                gl_account_id = 56,
                gl_account_name = '',
                gl_account_type = fineract_client.models.enum_option_data.EnumOptionData(
                    code = '', 
                    id = 56, 
                    value = '', ),
                id = 56,
                ...
                transaction_details = fineract_client.models.transaction_detail_data.TransactionDetailData(
                    note_data = fineract_client.models.note_data.NoteData(
                        ...
                        note = '', 
                        note_type = fineract_client.models.enum_option_data.EnumOptionData(
                            code = '', 
                            id = 56, 
                            value = '', ), 
