...
class TestGetSelfClientsTimeline(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetSelfClientsTimeline:
        """Test GetSelfClientsTimeline
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSelfClientsTimeline`
        """
        model = GetSelfClientsTimeline()
        if include_optional:
