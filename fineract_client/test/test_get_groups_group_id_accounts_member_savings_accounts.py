...
class TestGetGroupsGroupIdAccountsMemberSavingsAccounts(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetGroupsGroupIdAccountsMemberSavingsAccounts:
        """Test GetGroupsGroupIdAccountsMemberSavingsAccounts
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGroupsGroupIdAccountsMemberSavingsAccounts`
        """
        model = GetGroupsGroupIdAccountsMemberSavingsAccounts()
        if include_optional:
            return GetGroupsGroupIdAccountsMemberSavingsAccounts(
                account_no = 3,
