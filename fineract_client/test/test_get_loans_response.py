...
class TestGetLoansResponse(unittest.TestCase):
    """GetLoansResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLoansResponse:
        """Test GetLoansResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLoansResponse`
        """
        model = GetLoansResponse()
        if include_optional:
            return GetLoansResponse(
                page_items = [
                    fineract_client.models.get_loans_loan_id_response.GetLoansLoanIdResponse(
