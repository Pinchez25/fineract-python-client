...
class TestPageJournalEntryData(unittest.TestCase):
    """PageJournalEntryData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PageJournalEntryData:
        """Test PageJournalEntryData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PageJournalEntryData`
        """
        model = PageJournalEntryData()
        if include_optional:
            return PageJournalEntryData(
                content = [
    ...
    def testPageJournalEntryData(self):
        """Test PageJournalEntryData"""
