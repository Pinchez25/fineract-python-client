...
class TestInteropTransactionData(unittest.TestCase):
    """InteropTransactionData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InteropTransactionData:
        """Test InteropTransactionData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InteropTransactionData`
        """
        model = InteropTransactionData()
        if include_optional:
            return InteropTransactionData(
    ...
    def testInteropTransactionData(self):
        """Test InteropTransactionData"""
