...
class TestGetGroupsGroupIdAccountsMemberLoanAccounts(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetGroupsGroupIdAccountsMemberLoanAccounts:
        """Test GetGroupsGroupIdAccountsMemberLoanAccounts
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGroupsGroupIdAccountsMemberLoanAccounts`
        """
        model = GetGroupsGroupIdAccountsMemberLoanAccounts()
        if include_optional:
            return GetGroupsGroupIdAccountsMemberLoanAccounts(
                account_no = 4,
                id = 4,
