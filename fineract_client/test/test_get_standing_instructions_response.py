...
class TestGetStandingInstructionsResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetStandingInstructionsResponse:
        ...
        if include_optional:
            return GetStandingInstructionsResponse(
                page_items = [
                    fineract_client.models.get_page_items_standing_instruction_swagger.GetPageItemsStandingInstructionSwagger(
                        account_detail_id = 6, 
                        amount = 150, 
