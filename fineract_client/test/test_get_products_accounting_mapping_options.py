...
class TestGetProductsAccountingMappingOptions(unittest.TestCase):
    """GetProductsAccountingMappingOptions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetProductsAccountingMappingOptions:
        """Test GetProductsAccountingMappingOptions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetProductsAccountingMappingOptions`
        """
        model = GetProductsAccountingMappingOptions()
        if include_optional:
            return GetProductsAccountingMappingOptions(
                ...
                equity_account_options = [
                    fineract_client.models.get_products_equity_account_options.GetProductsEquityAccountOptions(
                        ...
                        tag_id = fineract_client.models.get_products_tag_id.GetProductsTagId(
                            id = 0, 
                            is_active = False, ), 
                        type = fineract_client.models.get_equity_type.GetEquityType(
                ...
                income_account_options = [
                    fineract_client.models.get_products_income_account_options.GetProductsIncomeAccountOptions(
                        ...
                        tag_id = fineract_client.models.get_products_tag_id.GetProductsTagId(
                            id = 0, 
                            is_active = False, ), 
                        type = fineract_client.models.get_income_type.GetIncomeType(
    ...
    def testGetProductsAccountingMappingOptions(self):
        """Test GetProductsAccountingMappingOptions"""
