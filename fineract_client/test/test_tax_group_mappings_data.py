...
class TestTaxGroupMappingsData(unittest.TestCase):
    """TaxGroupMappingsData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaxGroupMappingsData:
        """Test TaxGroupMappingsData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TaxGroupMappingsData`
        """
        model = TaxGroupMappingsData()
        if include_optional:
            return TaxGroupMappingsData(
    ...
    def testTaxGroupMappingsData(self):
        """Test TaxGroupMappingsData"""
