...
class StandingInstructionsHistoryApi(object):
    ...
    def retrieve_all20(self, **kwargs):  # noqa: E501
        """Standing Instructions Logged History  # noqa: E501

        The list capability of history can support pagination and sorting   Example Requests :  standinginstructionrunhistory  standinginstructionrunhistory?orderBy=name&sortOrder=DESC  standinginstructionrunhistory?offset=10&limit=50  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.retrieve_all20(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.retrieve_all20_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.retrieve_all20_with_http_info(**kwargs)  # noqa: E501
            return data

    def retrieve_all20_with_http_info(self, **kwargs):  # noqa: E501
        """Standing Instructions Logged History  # noqa: E501

        The list capability of history can support pagination and sorting   Example Requests :  standinginstructionrunhistory  standinginstructionrunhistory?orderBy=name&sortOrder=DESC  standinginstructionrunhistory?offset=10&limit=50  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.retrieve_all20_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['external_id', 'offset', 'limit', 'order_by', 'sort_order', 'transfer_type', 'client_name', 'client_id', 'from_account_id', 'from_account_type', 'locale', 'date_format', 'from_date', 'to_date']  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/standinginstructionrunhistory', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='GetStandingInstructionRunHistoryResponse',  # noqa: E501
