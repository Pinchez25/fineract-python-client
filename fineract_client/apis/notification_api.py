...
class NotificationApi(object):
    ...
    def get_all_notifications_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['order_by', 'limit', 'offset', 'sort_order', 'is_read']  # noqa: E501
    ...
    def update5(self, **kwargs):  # noqa: E501
        """update5  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update5(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update5_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.update5_with_http_info(**kwargs)  # noqa: E501
            return data

    def update5_with_http_info(self, **kwargs):  # noqa: E501
        """update5  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update5_with_http_info(async_req=True)
        >>> result = thread.get()
