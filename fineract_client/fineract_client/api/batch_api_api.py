...
class BatchAPIApi:
    ...
    def handle_batch_requests(
        ...
        enclosing_transaction: Annotated[Optional[StrictBool], Field(description="enclosingTransaction")] = None,
        ...
        :type batch_request: List[BatchRequest]
        :param enclosing_transaction: enclosingTransaction
        :type enclosing_transaction: bool
        ...
        _param = self._handle_batch_requests_serialize(
    ...
    @validate_call
    def handle_batch_requests_with_http_info(
        self,
        batch_request: List[BatchRequest],
        enclosing_transaction: Annotated[Optional[StrictBool], Field(description="enclosingTransaction")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def handle_batch_requests_without_preload_content(
        self,
        batch_request: List[BatchRequest],
        enclosing_transaction: Annotated[Optional[StrictBool], Field(description="enclosingTransaction")] = None,
        _request_timeout: Union[
    ...
    def _handle_batch_requests_serialize(
        self,
        batch_request,
        ...
        if enclosing_transaction is not None:
            
            _query_params.append(('enclosingTransaction', enclosing_transaction))
