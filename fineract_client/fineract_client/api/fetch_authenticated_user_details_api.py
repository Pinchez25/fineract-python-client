...
class FetchAuthenticatedUserDetailsApi:
    ...
    @validate_call
    def fetch_authenticated_user_data(
        self,
        ...
        _param = self._fetch_authenticated_user_data_serialize(
    ...
    @validate_call
    def fetch_authenticated_user_data_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def fetch_authenticated_user_data_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _fetch_authenticated_user_data_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
