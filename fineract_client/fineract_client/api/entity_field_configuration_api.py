...
class EntityFieldConfigurationApi:
    ...
    def get_addresses(
    ...
    ) -> List[GetFieldConfigurationEntityResponse]:
        ...
        _param = self._get_addresses_serialize(
            entity=entity,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[GetFieldConfigurationEntityResponse]",
        }
    ...
    @validate_call
    def get_addresses_with_http_info(
        self,
        entity: Annotated[StrictStr, Field(description="entity")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[GetFieldConfigurationEntityResponse]]:
        """Retrieves the Entity Field Configuration
    ...
    @validate_call
    def get_addresses_without_preload_content(
        self,
        entity: Annotated[StrictStr, Field(description="entity")],
        _request_timeout: Union[
            None,
    ...
    def _get_addresses_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/fieldconfiguration/{entity}',
