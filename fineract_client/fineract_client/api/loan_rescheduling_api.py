...
class LoanReschedulingApi:
    ...
    @validate_call
    def calculate_loan_schedule_or_submit_variable_schedule(
        self,
        ...
        _param = self._calculate_loan_schedule_or_submit_variable_schedule_serialize(
            loan_id=loan_id,
            body=body,
            command=command,
    ...
    @validate_call
    def calculate_loan_schedule_or_submit_variable_schedule_with_http_info(
        self,
        loan_id: Annotated[StrictInt, Field(description="loanId")],
        body: Dict[str, Any],
        command: Annotated[Optional[StrictStr], Field(description="command")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PostLoansLoanIdScheduleResponse]:
        """Calculate loan repayment schedule based on Loan term variations | Updates loan repayment schedule based on Loan term variations | Updates loan repayment schedule by removing Loan term variations
    ...
    @validate_call
    def calculate_loan_schedule_or_submit_variable_schedule_without_preload_content(
        self,
        loan_id: Annotated[StrictInt, Field(description="loanId")],
        body: Dict[str, Any],
        command: Annotated[Optional[StrictStr], Field(description="command")] = None,
    ...
    def _calculate_loan_schedule_or_submit_variable_schedule_serialize(
        self,
        loan_id,
        body,
        command,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/loans/{loanId}/schedule',
