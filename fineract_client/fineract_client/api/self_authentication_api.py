...
class SelfAuthenticationApi:
    ...
    def authenticate1(
        ...
        _param = self._authenticate1_serialize(
    ...
    @validate_call
    def authenticate1_with_http_info(
        self,
        post_authentication_request: PostAuthenticationRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PostSelfAuthenticationResponse]:
        """Verify authentication
    ...
    @validate_call
    def authenticate1_without_preload_content(
        self,
        post_authentication_request: PostAuthenticationRequest,
        _request_timeout: Union[
            None,
    ...
    def _authenticate1_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/self/authentication',
