...
class LookupTableData(BaseModel):
    """
    LookupTableData
    """ # noqa: E501
    description: Optional[StrictStr] = None
    entries: Optional[List[LookupTableEntry]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "entries": [LookupTableEntry.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None,
            "key": obj.get("key")
        })
        return _obj
