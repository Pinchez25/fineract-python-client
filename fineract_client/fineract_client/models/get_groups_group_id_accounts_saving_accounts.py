...
class GetGroupsGroupIdAccountsSavingAccounts(BaseModel):
    """
    GetGroupsGroupIdAccountsSavingAccounts
    """ # noqa: E501
    account_no: Optional[StrictInt] = Field(default=None, alias="accountNo")
    account_type: Optional[GetGroupsGroupIdAccountsSavingAccountType] = Field(default=None, alias="accountType")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "accountType": GetGroupsGroupIdAccountsSavingAccountType.from_dict(obj["accountType"]) if obj.get("accountType") is not None else None,
