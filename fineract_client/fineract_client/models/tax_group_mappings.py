...
class TaxGroupMappings(BaseModel):
    """
    TaxGroupMappings
    """ # noqa: E501
    ...
    tax_component: Optional[TaxComponent] = Field(default=None, alias="taxComponent")
    tax_group: Optional[TaxGroup] = Field(default=None, alias="taxGroup")
    __properties: ClassVar[List[str]] = ["createdBy", "createdDate", "endDate", "id", "lastModifiedBy", "lastModifiedDate", "new", "taxComponent", "taxGroup"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of tax_component
        if self.tax_component:
            _dict['taxComponent'] = self.tax_component.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "new": obj.get("new"),
            "taxComponent": TaxComponent.from_dict(obj["taxComponent"]) if obj.get("taxComponent") is not None else None,
...
TaxGroupMappings.model_rebuild(raise_errors=False)
