...
class GetLoanChargeTemplateChargeOptions(BaseModel):
    """
    ...
    charge_time_type: Optional[GetLoanChargeTemplateChargeTimeType] = Field(default=None, alias="chargeTimeType")
    currency: Optional[GetLoanChargeCurrency] = None
    id: Optional[StrictInt] = None
    name: Optional[StrictStr] = None
    penalty: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["active", "amount", "chargeAppliesTo", "chargeCalculationType", "chargeTimeType", "currency", "id", "name", "penalty"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "chargeTimeType": GetLoanChargeTemplateChargeTimeType.from_dict(obj["chargeTimeType"]) if obj.get("chargeTimeType") is not None else None,
            "currency": GetLoanChargeCurrency.from_dict(obj["currency"]) if obj.get("currency") is not None else None,
            "id": obj.get("id"),
            "name": obj.get("name"),
