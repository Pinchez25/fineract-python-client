...
class FilterData(BaseModel):
    ...
    def operator_validate_enum(cls, value):
        ...
        if value not in set(['EQ', 'NEQ', 'GTE', 'LTE', 'GT', 'LT', 'LIKE', 'NLIKE', 'BTW', 'NBTW', 'IN', 'NIN', 'NULL', 'NNULL']):
            raise ValueError("must be one of enum values ('EQ', 'NEQ', 'GTE', 'LTE', 'GT', 'LT', 'LIKE', 'NLIKE', 'BTW', 'NBTW', 'IN', 'NIN', 'NULL', 'NNULL')")
        return value
