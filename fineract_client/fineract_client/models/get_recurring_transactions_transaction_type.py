...
class GetRecurringTransactionsTransactionType(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["code", "deposit", "description", "feeDeduction", "id", "interestPosting", "withdrawal"]
