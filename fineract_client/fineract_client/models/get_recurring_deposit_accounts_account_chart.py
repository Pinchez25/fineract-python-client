...
class GetRecurringDepositAccountsAccountChart(BaseModel):
    """
    ...
    chart_slabs: Optional[List[GetRecurringDepositAccountsChartSlabs]] = Field(default=None, alias="chartSlabs")
    from_date: Optional[date] = Field(default=None, alias="fromDate")
    id: Optional[StrictInt] = None
    period_types: Optional[List[GetRecurringDepositAccountsPeriodTypes]] = Field(default=None, alias="periodTypes")
    __properties: ClassVar[List[str]] = ["accountId", "accountNumber", "chartSlabs", "fromDate", "id", "periodTypes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "chartSlabs": [GetRecurringDepositAccountsChartSlabs.from_dict(_item) for _item in obj["chartSlabs"]] if obj.get("chartSlabs") is not None else None,
            "fromDate": obj.get("fromDate"),
            "id": obj.get("id"),
            "periodTypes": [GetRecurringDepositAccountsPeriodTypes.from_dict(_item) for _item in obj["periodTypes"]] if obj.get("periodTypes") is not None else None
        })
        return _obj
