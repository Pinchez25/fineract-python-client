...
class PostLoansLoanIdResponse(BaseModel):
    """
    PostLoansLoanIdResponse
    """ # noqa: E501
    changes: Optional[PostLoansLoanIdChanges] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": PostLoansLoanIdChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
