...
class GetGlobalConfigurationsResponse(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "globalConfiguration": [GlobalConfigurationPropertyData.from_dict(_item) for _item in obj["globalConfiguration"]] if obj.get("globalConfiguration") is not None else None
        })
        return _obj
