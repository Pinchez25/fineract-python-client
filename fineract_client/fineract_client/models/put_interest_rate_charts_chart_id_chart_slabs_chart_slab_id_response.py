...
class PutInterestRateChartsChartIdChartSlabsChartSlabIdResponse(BaseModel):
    """
    PutInterestRateChartsChartIdChartSlabsChartSlabIdResponse
    """ # noqa: E501
    changes: Optional[PutInterestRateChartsChartIdChartSlabsChartSlabIdRequest] = None
    resource_id: Optional[StrictInt] = Field(default=None, alias="resourceId")
    __properties: ClassVar[List[str]] = ["changes", "resourceId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": PutInterestRateChartsChartIdChartSlabsChartSlabIdRequest.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
