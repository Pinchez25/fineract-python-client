...
class PostTellersTellerIdCashiersCashierIdAllocateRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["currencyCode", "dateFormat", "locale", "txnAmount", "txnDate", "txnNote"]
