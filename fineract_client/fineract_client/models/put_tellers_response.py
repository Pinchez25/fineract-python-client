...
class PutTellersResponse(BaseModel):
    """
    PutTellersResponse
    """ # noqa: E501
    changes: Optional[PutTellersResponseChanges] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": PutTellersResponseChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
