...
class GetFloatingRatesFloatingRateIdResponse(BaseModel):
    """
    ...
    rate_periods: Optional[List[GetFloatingRatesRatePeriods]] = Field(default=None, alias="ratePeriods")
    __properties: ClassVar[List[str]] = ["createdBy", "createdOn", "id", "isActive", "isBaseLendingRate", "modifiedBy", "modifiedOn", "name", "ratePeriods"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "ratePeriods": [GetFloatingRatesRatePeriods.from_dict(_item) for _item in obj["ratePeriods"]] if obj.get("ratePeriods") is not None else None
        })
        return _obj
