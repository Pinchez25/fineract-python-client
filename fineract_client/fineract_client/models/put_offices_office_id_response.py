...
class PutOfficesOfficeIdResponse(BaseModel):
    """
    PutOfficesOfficeIdResponse
    """ # noqa: E501
    changes: Optional[PutOfficesOfficeIdResponseChanges] = None
    ...
    __properties: ClassVar[List[str]] = ["changes", "officeId", "resourceId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": PutOfficesOfficeIdResponseChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
