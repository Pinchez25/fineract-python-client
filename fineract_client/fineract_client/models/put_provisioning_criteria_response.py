...
class PutProvisioningCriteriaResponse(BaseModel):
    """
    PutProvisioningCriteriaResponse
    """ # noqa: E501
    changes: Optional[PutProvisioningCriteriaResponseChanges] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": PutProvisioningCriteriaResponseChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
