...
class PutProductsTypeProductIdResponse(BaseModel):
    """
    PutProductsTypeProductIdResponse
    """ # noqa: E501
    changes: Optional[PutProductsChanges] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": PutProductsChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
