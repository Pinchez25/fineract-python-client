...
class PutStandingInstructionsStandingInstructionIdResponse(BaseModel):
    """
    PutStandingInstructionsStandingInstructionIdResponse
    """ # noqa: E501
    changes: Optional[PutUpdateStandingInstructionChanges] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": PutUpdateStandingInstructionChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
