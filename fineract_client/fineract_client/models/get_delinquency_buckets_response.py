...
class GetDelinquencyBucketsResponse(BaseModel):
    """
    GetDelinquencyBucketsResponse
    """ # noqa: E501
    id: Optional[StrictInt] = None
    name: Optional[StrictStr] = None
    ranges: Optional[List[GetDelinquencyRangesResponse]] = None
    __properties: ClassVar[List[str]] = ["id", "name", "ranges"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "ranges": [GetDelinquencyRangesResponse.from_dict(_item) for _item in obj["ranges"]] if obj.get("ranges") is not None else None
        })
        return _obj
