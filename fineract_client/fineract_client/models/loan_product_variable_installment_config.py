...
class LoanProductVariableInstallmentConfig(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "loanProduct", "maximumGap", "minimumGap", "new"]
...
LoanProductVariableInstallmentConfig.model_rebuild(raise_errors=False)
