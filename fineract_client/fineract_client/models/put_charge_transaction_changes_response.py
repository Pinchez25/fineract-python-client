...
class PutChargeTransactionChangesResponse(BaseModel):
    """
    PutChargeTransactionChangesResponse
    """ # noqa: E501
    changes: Optional[PutChargeTransactionChangesResponseChanges] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": PutChargeTransactionChangesResponseChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
