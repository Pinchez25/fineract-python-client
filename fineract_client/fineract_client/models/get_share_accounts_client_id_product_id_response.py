...
class GetShareAccountsClientIdProductIdResponse(BaseModel):
    """
    GetShareAccountsClientIdProductIdResponse
    """ # noqa: E501
    charge_options: Optional[List[GetClientIdProductIdChargeOptions]] = Field(default=None, alias="chargeOptions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "chargeOptions": [GetClientIdProductIdChargeOptions.from_dict(_item) for _item in obj["chargeOptions"]] if obj.get("chargeOptions") is not None else None,
            "productOptions": [GetClientIdProductIdProductOptions.from_dict(_item) for _item in obj["productOptions"]] if obj.get("productOptions") is not None else None
        })
        return _obj
