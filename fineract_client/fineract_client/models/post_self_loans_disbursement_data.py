...
class PostSelfLoansDisbursementData(BaseModel):
    """
    PostSelfLoansDisbursementData
    """ # noqa: E501
    approved_principal: Optional[StrictInt] = Field(default=None, alias="approvedPrincipal")
    ...
    __properties: ClassVar[List[str]] = ["approvedPrincipal", "expectedDisbursementDate", "principal"]
