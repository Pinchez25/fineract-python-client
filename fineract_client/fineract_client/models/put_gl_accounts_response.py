...
class PutGLAccountsResponse(BaseModel):
    """
    PutGLAccountsResponse
    """ # noqa: E501
    changes: Optional[PutGLAccountsResponsechangesSwagger] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": PutGLAccountsResponsechangesSwagger.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
