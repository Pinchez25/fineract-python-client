...
class PaymentTypeToGLAccountMapper(BaseModel):
    """
    PaymentTypeToGLAccountMapper
    """ # noqa: E501
    fund_source_account: Optional[GLAccountData] = Field(default=None, alias="fundSourceAccount")
    payment_type: Optional[PaymentTypeData] = Field(default=None, alias="paymentType")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "fundSourceAccount": GLAccountData.from_dict(obj["fundSourceAccount"]) if obj.get("fundSourceAccount") is not None else None,
            "paymentType": PaymentTypeData.from_dict(obj["paymentType"]) if obj.get("paymentType") is not None else None
        })
        return _obj
