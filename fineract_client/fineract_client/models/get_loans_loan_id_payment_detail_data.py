...
class GetLoansLoanIdPaymentDetailData(BaseModel):
    """
    Payment detail
    """ # noqa: E501
    ...
    payment_type: Optional[GetLoansLoanIdPaymentType] = Field(default=None, alias="paymentType")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "paymentType": GetLoansLoanIdPaymentType.from_dict(obj["paymentType"]) if obj.get("paymentType") is not None else None,
