...
class GetWorkingDaysTemplateResponse(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "repaymentRescheduleOptions": [EnumOptionData.from_dict(_item) for _item in obj["repaymentRescheduleOptions"]] if obj.get("repaymentRescheduleOptions") is not None else None
        })
        return _obj
