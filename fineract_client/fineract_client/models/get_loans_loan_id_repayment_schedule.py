...
class GetLoansLoanIdRepaymentSchedule(BaseModel):
    """
    ...
    periods: Optional[List[GetLoansLoanIdRepaymentPeriod]] = None
    total_fee_charges_charged: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="totalFeeChargesCharged")
    ...
    total_paid_in_advance: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="totalPaidInAdvance")
    total_paid_late: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="totalPaidLate")
    total_penalty_charges_charged: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="totalPenaltyChargesCharged")
    total_principal_disbursed: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="totalPrincipalDisbursed")
    total_principal_expected: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="totalPrincipalExpected")
    total_principal_paid: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="totalPrincipalPaid")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "periods": [GetLoansLoanIdRepaymentPeriod.from_dict(_item) for _item in obj["periods"]] if obj.get("periods") is not None else None,
            ...
            "totalPaidInAdvance": obj.get("totalPaidInAdvance"),
            "totalPaidLate": obj.get("totalPaidLate"),
