...
class PostFixedDepositAccountsRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["clientId", "dateFormat", "depositAmount", "depositPeriod", "depositPeriodFrequencyId", "locale", "productId", "submittedOnDate"]
