...
external_owner_transfer_journal_entry_data_form_dict = external_owner_transfer_journal_entry_data.from_dict(external_owner_transfer_journal_entry_data_dict)
```
