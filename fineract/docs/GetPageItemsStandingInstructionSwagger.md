...
get_page_items_standing_instruction_swagger_form_dict = get_page_items_standing_instruction_swagger.from_dict(get_page_items_standing_instruction_swagger_dict)
```
