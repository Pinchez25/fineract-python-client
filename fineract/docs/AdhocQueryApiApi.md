...
with fineract_client.ApiClient(configuration) as api_client:
    ...
    api_instance = fineract_client.AdhocQueryApiApi(api_client)
    body = 'body_example' # str |  (optional)

    try:
        api_response = api_instance.create_ad_hoc_query(body=body)
        print("The response of AdhocQueryApiApi->create_ad_hoc_query:\n")
        pprint(api_response)
...
with fineract_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = fineract_client.AdhocQueryApiApi(api_client)
    ad_hoc_id = 56 # int | adHocId

    try:
        api_response = api_instance.delete_ad_hoc_query(ad_hoc_id)
        print("The response of AdhocQueryApiApi->delete_ad_hoc_query:\n")
        pprint(api_response)
    except Exception as e:
...
with fineract_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of AdhocQueryApiApi->retrieve_ad_hoc_query:\n")
        pprint(api_response)
    except Exception as e:
...
with fineract_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of AdhocQueryApiApi->retrieve_all2:\n")
        pprint(api_response)
    except Exception as e:
...
with fineract_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of AdhocQueryApiApi->template:\n")
        pprint(api_response)
    except Exception as e:
...
with fineract_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of AdhocQueryApiApi->update:\n")
        pprint(api_response)
    except Exception as e:
