...
with fineract_client.ApiClient(configuration) as api_client:
    ...
    api_instance = fineract_client.SelfServiceRegistrationApi(api_client)
    body = 'body_example' # str |  (optional)

    try:
        api_response = api_instance.create_self_service_registration_request(body=body)
        print("The response of SelfServiceRegistrationApi->create_self_service_registration_request:\n")
        pprint(api_response)
...
with fineract_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SelfServiceRegistrationApi->create_self_service_user:\n")
        pprint(api_response)
    except Exception as e:
