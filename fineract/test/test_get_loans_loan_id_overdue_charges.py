...
class TestGetLoansLoanIdOverdueCharges(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetLoansLoanIdOverdueCharges:
        """Test GetLoansLoanIdOverdueCharges
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLoansLoanIdOverdueCharges`
        """
        model = GetLoansLoanIdOverdueCharges()
        if include_optional:
            return GetLoansLoanIdOverdueCharges(
                active = True,
                amount = 3,
