...
class TestGetLoanProductsInterestRecalculationTemplateData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetLoanProductsInterestRecalculationTemplateData:
        ...
        """
        model = GetLoanProductsInterestRecalculationTemplateData()
        if include_optional:
            return GetLoanProductsInterestRecalculationTemplateData(
