...
class TestGetProductsAssetAccountOptions(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetProductsAssetAccountOptions:
        """Test GetProductsAssetAccountOptions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetProductsAssetAccountOptions`
        """
        model = GetProductsAssetAccountOptions()
        if include_optional:
            return GetProductsAssetAccountOptions(
