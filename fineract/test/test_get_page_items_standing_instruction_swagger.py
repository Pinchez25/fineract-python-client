...
class TestGetPageItemsStandingInstructionSwagger(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetPageItemsStandingInstructionSwagger:
        ...
        """
        model = GetPageItemsStandingInstructionSwagger()
        if include_optional:
            return GetPageItemsStandingInstructionSwagger(
                account_detail_id = 6,
                amount = 150,
