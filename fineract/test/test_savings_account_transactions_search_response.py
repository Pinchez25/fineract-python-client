...
class TestSavingsAccountTransactionsSearchResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SavingsAccountTransactionsSearchResponse:
        ...
        """
        model = SavingsAccountTransactionsSearchResponse()
        if include_optional:
            return SavingsAccountTransactionsSearchResponse(
                content = [
                    fineract_client.models.get_savings_account_transactions_page_item.GetSavingsAccountTransactionsPageItem(
                        account_id = 1, 
