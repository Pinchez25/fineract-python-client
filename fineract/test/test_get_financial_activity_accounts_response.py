...
class TestGetFinancialActivityAccountsResponse(unittest.TestCase):
    """GetFinancialActivityAccountsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFinancialActivityAccountsResponse:
        """Test GetFinancialActivityAccountsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFinancialActivityAccountsResponse`
        """
        model = GetFinancialActivityAccountsResponse()
        if include_optional:
            return GetFinancialActivityAccountsResponse(
                financial_activity_data = fineract_client.models.financial_activity_data.FinancialActivityData(
                    id = 56, 
                    mapped_gl_account_type = 'ASSET', 
                    name = '', ),
                gl_account_data = fineract_client.models.gl_account_data.GLAccountData(
    ...
    def testGetFinancialActivityAccountsResponse(self):
        """Test GetFinancialActivityAccountsResponse"""
