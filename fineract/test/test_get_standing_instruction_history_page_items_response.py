...
class TestGetStandingInstructionHistoryPageItemsResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetStandingInstructionHistoryPageItemsResponse:
        ...
        """
        model = GetStandingInstructionHistoryPageItemsResponse()
        if include_optional:
            return GetStandingInstructionHistoryPageItemsResponse(
                amount = 10,
                error_log = '',
