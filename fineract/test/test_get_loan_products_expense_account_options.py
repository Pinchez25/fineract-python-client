...
class TestGetLoanProductsExpenseAccountOptions(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetLoanProductsExpenseAccountOptions:
        """Test GetLoanProductsExpenseAccountOptions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLoanProductsExpenseAccountOptions`
        """
        model = GetLoanProductsExpenseAccountOptions()
        if include_optional:
            return GetLoanProductsExpenseAccountOptions(
                disabled = False,
                gl_code = '12',
                id = 10,
