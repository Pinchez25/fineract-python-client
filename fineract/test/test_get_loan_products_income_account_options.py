...
class TestGetLoanProductsIncomeAccountOptions(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetLoanProductsIncomeAccountOptions:
        ...
        """
        model = GetLoanProductsIncomeAccountOptions()
        if include_optional:
            return GetLoanProductsIncomeAccountOptions(
                disabled = False,
                gl_code = '04',
                id = 4,
