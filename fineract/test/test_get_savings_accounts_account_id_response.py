...
class TestGetSavingsAccountsAccountIdResponse(unittest.TestCase):
    """GetSavingsAccountsAccountIdResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSavingsAccountsAccountIdResponse:
        """Test GetSavingsAccountsAccountIdResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSavingsAccountsAccountIdResponse`
        """
        model = GetSavingsAccountsAccountIdResponse()
        if include_optional:
            return GetSavingsAccountsAccountIdResponse(
                ...
                summary = fineract_client.models.get_savings_accounts_summary.GetSavingsAccountsSummary(
                    account_balance = 0, 
                    available_balance = 0, 
                    currency = fineract_client.models.get_savings_currency.GetSavingsCurrency(
                        code = 'USD', 
    ...
    def testGetSavingsAccountsAccountIdResponse(self):
        """Test GetSavingsAccountsAccountIdResponse"""
