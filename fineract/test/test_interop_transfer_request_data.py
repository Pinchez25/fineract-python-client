...
class TestInteropTransferRequestData(unittest.TestCase):
    """InteropTransferRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InteropTransferRequestData:
        """Test InteropTransferRequestData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InteropTransferRequestData`
        """
        model = InteropTransferRequestData()
        if include_optional:
            return InteropTransferRequestData(
                account_id = '',
                ...
                fsp_commission = fineract_client.models.money_data.MoneyData(
                    amount = 1.337, 
                    currency = '', ),
                fsp_fee = fineract_client.models.money_data.MoneyData(
                    amount = 1.337, 
                    currency = '', ),
    ...
    def testInteropTransferRequestData(self):
        """Test InteropTransferRequestData"""
