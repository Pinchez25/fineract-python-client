...
class TestExternalOwnerTransferJournalEntryData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ExternalOwnerTransferJournalEntryData:
        ...
        """
        model = ExternalOwnerTransferJournalEntryData()
        if include_optional:
            return ExternalOwnerTransferJournalEntryData(
                journal_entry_data = fineract_client.models.page_journal_entry_data.PageJournalEntryData(
                    ...
                    total_elements = 56, 
                    total_pages = 56, ),
                transfer_data = fineract_client.models.external_transfer_data.ExternalTransferData(
