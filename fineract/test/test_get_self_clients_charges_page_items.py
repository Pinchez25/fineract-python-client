...
class TestGetSelfClientsChargesPageItems(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetSelfClientsChargesPageItems:
        """Test GetSelfClientsChargesPageItems
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSelfClientsChargesPageItems`
        """
        model = GetSelfClientsChargesPageItems()
        if include_optional:
            return GetSelfClientsChargesPageItems(
                amount = 550,
