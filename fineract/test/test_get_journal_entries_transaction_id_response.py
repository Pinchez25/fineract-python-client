...
class TestGetJournalEntriesTransactionIdResponse(unittest.TestCase):
    """GetJournalEntriesTransactionIdResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetJournalEntriesTransactionIdResponse:
        """Test GetJournalEntriesTransactionIdResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetJournalEntriesTransactionIdResponse`
        """
        model = GetJournalEntriesTransactionIdResponse()
        if include_optional:
            return GetJournalEntriesTransactionIdResponse(
                page_items = [
                    fineract_client.models.journal_entry_transaction_item.JournalEntryTransactionItem(
                        amount = 100, 
    ...
    def testGetJournalEntriesTransactionIdResponse(self):
        """Test GetJournalEntriesTransactionIdResponse"""
