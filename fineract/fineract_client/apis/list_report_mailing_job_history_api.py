...
class ListReportMailingJobHistoryApi:
    ...
    @validate_call
    def retrieve_all_by_report_mailing_job_id(
        self,
        report_mailing_job_id: Annotated[Optional[StrictInt], Field(description="reportMailingJobId")] = None,
        ...
        :param report_mailing_job_id: reportMailingJobId
        :type report_mailing_job_id: int
        :param offset: offset
        :type offset: int
        :param limit: limit
        :type limit: int
        ...
        _param = self._retrieve_all_by_report_mailing_job_id_serialize(
            report_mailing_job_id=report_mailing_job_id,
            offset=offset,
            limit=limit,
            order_by=order_by,
    ...
    @validate_call
    def retrieve_all_by_report_mailing_job_id_with_http_info(
        self,
        report_mailing_job_id: Annotated[Optional[StrictInt], Field(description="reportMailingJobId")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="offset")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="limit")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ReportMailingJobRunHistoryData]:
        """List Report Mailing Job History
    ...
    @validate_call
    def retrieve_all_by_report_mailing_job_id_without_preload_content(
        self,
        report_mailing_job_id: Annotated[Optional[StrictInt], Field(description="reportMailingJobId")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="offset")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="limit")] = None,
    ...
    def _retrieve_all_by_report_mailing_job_id_serialize(
        self,
        report_mailing_job_id,
        offset,
        limit,
        order_by,
        sort_order,
        ...
        if report_mailing_job_id is not None:
            ...
            _query_params.append(('reportMailingJobId', report_mailing_job_id))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/reportmailingjobrunhistory',
