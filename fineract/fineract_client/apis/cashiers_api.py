...
class CashiersApi:
    ...
    def get_cashier_data(
        ...
        _param = self._get_cashier_data_serialize(
            office_id=office_id,
            teller_id=teller_id,
            staff_id=staff_id,
            var_date=var_date,
    ...
    @validate_call
    def get_cashier_data_with_http_info(
        self,
        office_id: Optional[StrictInt] = None,
        teller_id: Optional[StrictInt] = None,
        staff_id: Optional[StrictInt] = None,
    ...
    @validate_call
    def get_cashier_data_without_preload_content(
        self,
        office_id: Optional[StrictInt] = None,
        teller_id: Optional[StrictInt] = None,
        staff_id: Optional[StrictInt] = None,
    ...
    def _get_cashier_data_serialize(
        self,
        office_id,
        teller_id,
        staff_id,
