...
class AuthenticationHTTPBasicApi:
    ...
    def authenticate(
        self,
        post_authentication_request: PostAuthenticationRequest,
        return_client_list: Optional[StrictBool] = None,
        ...
        :param post_authentication_request: (required)
        :type post_authentication_request: PostAuthenticationRequest
        :param return_client_list:
        :type return_client_list: bool
        ...
        _param = self._authenticate_serialize(
            post_authentication_request=post_authentication_request,
            return_client_list=return_client_list,
    ...
    def authenticate_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PostAuthenticationResponse]:
        """Verify authentication
    ...
    def _authenticate_serialize(
        ...
        if return_client_list is not None:
            
            _query_params.append(('returnClientList', return_client_list))
            
        # process the header parameters
        # process the form parameters
        # process the body parameter
        if post_authentication_request is not None:
            _body_params = post_authentication_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/authentication',
