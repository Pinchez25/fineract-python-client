...
class SelfSpmApi:
    ...
    def fetch_all_surveys(
        ...
        _param = self._fetch_all_surveys_serialize(
    ...
    @validate_call
    def fetch_all_surveys_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def fetch_all_surveys_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _fetch_all_surveys_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
