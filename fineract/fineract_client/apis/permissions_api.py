...
class PermissionsApi:
    ...
    def retrieve_all_permissions(
        ...
        _param = self._retrieve_all_permissions_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[GetPermissionsResponse]",
        }
    ...
    @validate_call
    def retrieve_all_permissions_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[GetPermissionsResponse]]:
        """List Application Permissions
    ...
    @validate_call
    def retrieve_all_permissions_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _retrieve_all_permissions_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    @validate_call
    def update_permissions_details(
        self,
        put_permissions_request: PutPermissionsRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param put_permissions_request: (required)
        :type put_permissions_request: PutPermissionsRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_permissions_details_serialize(
    ...
    @validate_call
    def update_permissions_details_with_http_info(
        self,
        put_permissions_request: PutPermissionsRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def update_permissions_details_without_preload_content(
        self,
        put_permissions_request: PutPermissionsRequest,
        _request_timeout: Union[
            None,
    ...
    def _update_permissions_details_serialize(
        self,
        ...
        # process the form parameters
        # process the body parameter
        if put_permissions_request is not None:
            _body_params = put_permissions_request
