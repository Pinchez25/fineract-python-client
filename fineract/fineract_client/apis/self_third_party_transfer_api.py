...
class SelfThirdPartyTransferApi:
    ...
    def add(
        self,
        post_self_beneficiaries_tpt_request: PostSelfBeneficiariesTPTRequest,
        ...
        :param post_self_beneficiaries_tpt_request: (required)
        :type post_self_beneficiaries_tpt_request: PostSelfBeneficiariesTPTRequest
        ...
        _param = self._add_serialize(
            post_self_beneficiaries_tpt_request=post_self_beneficiaries_tpt_request,
    ...
    def add_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PostSelfBeneficiariesTPTResponse]:
        """Add TPT Beneficiary
    ...
    def _add_serialize(
        self,
        post_self_beneficiaries_tpt_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if post_self_beneficiaries_tpt_request is not None:
            _body_params = post_self_beneficiaries_tpt_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/self/beneficiaries/tpt',
    ...
    def delete22(
        ...
        _param = self._delete22_serialize(
    ...
    def delete22_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DeleteSelfBeneficiariesTPTBeneficiaryIdResponse]:
        """Delete TPT Beneficiary
    ...
    @validate_call
    def delete22_without_preload_content(
        self,
        beneficiary_id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _delete22_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/v1/self/beneficiaries/tpt/{beneficiaryId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def retrieve_all35(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> List[GetSelfBeneficiariesTPTResponse]:
        ...
        _param = self._retrieve_all35_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[GetSelfBeneficiariesTPTResponse]",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def retrieve_all35_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[GetSelfBeneficiariesTPTResponse]]:
        """Get All TPT Beneficiary
    ...
    @validate_call
    def retrieve_all35_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def template16(
        ...
        _param = self._template16_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def template16_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetSelfBeneficiariesTPTTemplateResponse]:
        """Beneficiary Third Party Transfer Template
    ...
    @validate_call
    def template16_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _template16_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/self/beneficiaries/tpt/template',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update23(
        self,
        beneficiary_id: Annotated[StrictInt, Field(description="beneficiaryId")],
        put_self_beneficiaries_tpt_beneficiary_id_request: PutSelfBeneficiariesTPTBeneficiaryIdRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param beneficiary_id: beneficiaryId (required)
        :type beneficiary_id: int
        :param put_self_beneficiaries_tpt_beneficiary_id_request: (required)
        :type put_self_beneficiaries_tpt_beneficiary_id_request: PutSelfBeneficiariesTPTBeneficiaryIdRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update23_serialize(
            beneficiary_id=beneficiary_id,
            put_self_beneficiaries_tpt_beneficiary_id_request=put_self_beneficiaries_tpt_beneficiary_id_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def update23_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PutSelfBeneficiariesTPTBeneficiaryIdResponse]:
        """Update TPT Beneficiary
    ...
    @validate_call
    def update23_without_preload_content(
        self,
        beneficiary_id: Annotated[StrictInt, Field(description="beneficiaryId")],
        put_self_beneficiaries_tpt_beneficiary_id_request: PutSelfBeneficiariesTPTBeneficiaryIdRequest,
        _request_timeout: Union[
    ...
    def _update23_serialize(
        self,
        beneficiary_id,
        put_self_beneficiaries_tpt_beneficiary_id_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if put_self_beneficiaries_tpt_beneficiary_id_request is not None:
            _body_params = put_self_beneficiaries_tpt_beneficiary_id_request
