...
class SelfUserDetailsApi:
    ...
    @validate_call
    def fetch_authenticated_user_data1(
        self,
        ...
        _param = self._fetch_authenticated_user_data1_serialize(
    ...
    @validate_call
    def fetch_authenticated_user_data1_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetSelfUserDetailsResponse]:
        """Fetch authenticated user details
    ...
    @validate_call
    def fetch_authenticated_user_data1_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _fetch_authenticated_user_data1_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/self/userdetails',
