...
class HooksApi:
    ...
    def create_hook(
        self,
        post_hook_request: PostHookRequest,
        ...
        :param post_hook_request: (required)
        :type post_hook_request: PostHookRequest
        ...
        _param = self._create_hook_serialize(
            post_hook_request=post_hook_request,
    ...
    def _create_hook_serialize(
        ...
        if post_hook_request is not None:
            _body_params = post_hook_request
    ...
    def delete_hook(
        self,
        hook_id: Annotated[StrictInt, Field(description="hookId")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def delete_hook_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DeleteHookResponse]:
        """Delete a Hook
    ...
    def retrieve_hook(
        ...
        _param = self._retrieve_hook_serialize(
            hook_id=hook_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def retrieve_hook_with_http_info(
        self,
        hook_id: Annotated[StrictInt, Field(description="hookId")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def retrieve_hook_without_preload_content(
        self,
        hook_id: Annotated[StrictInt, Field(description="hookId")],
        _request_timeout: Union[
            None,
    ...
    def retrieve_hooks(
        ...
        _param = self._retrieve_hooks_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def retrieve_hooks_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[GetHookResponse]]:
        """Retrieve Hooks
    ...
    @validate_call
    def retrieve_hooks_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def template3(
        ...
        _param = self._template3_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def template3_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetHookTemplateResponse]:
        """Retrieve Hooks Template
    ...
    @validate_call
    def template3_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _template3_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/hooks/template',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_hook(
        self,
        hook_id: Annotated[StrictInt, Field(description="hookId")],
        put_hook_request: PutHookRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param hook_id: hookId (required)
        :type hook_id: int
        :param put_hook_request: (required)
        :type put_hook_request: PutHookRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_hook_serialize(
            hook_id=hook_id,
            put_hook_request=put_hook_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _update_hook_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if put_hook_request is not None:
            _body_params = put_hook_request
