...
class LoanAccountLockApi:
    ...
    def retrieve_locked_accounts(
        ...
        _param = self._retrieve_locked_accounts_serialize(
            page=page,
            limit=limit,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetLoanAccountLockResponse",
        }
    ...
    @validate_call
    def retrieve_locked_accounts_with_http_info(
        self,
        page: Optional[StrictInt] = None,
        limit: Optional[StrictInt] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetLoanAccountLockResponse]:
        """List locked loan accounts
    ...
    @validate_call
    def retrieve_locked_accounts_without_preload_content(
        self,
        page: Optional[StrictInt] = None,
        limit: Optional[StrictInt] = None,
        _request_timeout: Union[
    ...
    def _retrieve_locked_accounts_serialize(
        self,
        page,
        limit,
        _request_auth,
