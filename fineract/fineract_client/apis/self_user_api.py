...
class SelfUserApi:
    ...
    def update24(
        self,
        put_self_user_request: PutSelfUserRequest,
        ...
        :param put_self_user_request: (required)
        :type put_self_user_request: PutSelfUserRequest
        ...
        _param = self._update24_serialize(
            put_self_user_request=put_self_user_request,
    ...
    def update24_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PutSelfUserResponse]:
        """Update User
    ...
    @validate_call
    def update24_without_preload_content(
        self,
        put_self_user_request: PutSelfUserRequest,
        _request_timeout: Union[
            None,
    ...
    def _update24_serialize(
        self,
        put_self_user_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if put_self_user_request is not None:
            _body_params = put_self_user_request
