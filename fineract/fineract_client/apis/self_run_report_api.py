...
class SelfRunReportApi:
    ...
    def run_report1(
        ...
        _param = self._run_report1_serialize(
    ...
    @validate_call
    def run_report1_with_http_info(
        self,
        report_name: Annotated[StrictStr, Field(description="reportName")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetRunReportResponse]:
        """Running A Report
    ...
    @validate_call
    def run_report1_without_preload_content(
        self,
        report_name: Annotated[StrictStr, Field(description="reportName")],
        _request_timeout: Union[
            None,
    ...
    def _run_report1_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/self/runreports/{reportName}',
