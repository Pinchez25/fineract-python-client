...
class SelfAccountTransferApi:
    ...
    def create14(
        ...
        _param = self._create14_serialize(
            type=type,
            body=body,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[PostNewTransferResponse]",
        }
    ...
    def create14_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[PostNewTransferResponse]]:
        """Create new Transfer
    ...
    @validate_call
    def create14_without_preload_content(
        self,
        type: Optional[StrictStr] = None,
        body: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _create14_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/self/accounttransfers',
    ...
    def template15(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> List[GetAccountTransferTemplateResponse]:
        ...
        _param = self._template15_serialize(
            type=type,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[GetAccountTransferTemplateResponse]",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def template15_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[GetAccountTransferTemplateResponse]]:
        """Retrieve Account Transfer Template
    ...
    @validate_call
    def template15_without_preload_content(
        self,
        type: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
    ...
    def _template15_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/self/accounttransfers/template',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
