...
class SearchAPIApi:
    ...
    def advanced_search(
        self,
        post_adhoc_query_search_request: PostAdhocQuerySearchRequest,
        ...
        :param post_adhoc_query_search_request: (required)
        :type post_adhoc_query_search_request: PostAdhocQuerySearchRequest
        ...
        _param = self._advanced_search_serialize(
            post_adhoc_query_search_request=post_adhoc_query_search_request,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[PostAdhocQuerySearchResponse]",
        }
    ...
    @validate_call
    def advanced_search_with_http_info(
        self,
        post_adhoc_query_search_request: PostAdhocQuerySearchRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[PostAdhocQuerySearchResponse]]:
        """Adhoc query search
    ...
    @validate_call
    def advanced_search_without_preload_content(
        self,
        post_adhoc_query_search_request: PostAdhocQuerySearchRequest,
        _request_timeout: Union[
            None,
    ...
    def _advanced_search_serialize(
        self,
        post_adhoc_query_search_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if post_adhoc_query_search_request is not None:
            _body_params = post_adhoc_query_search_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/search/advance',
    ...
    @validate_call
    def retrieve_ad_hoc_search_query_template(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._retrieve_ad_hoc_search_query_template_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def retrieve_ad_hoc_search_query_template_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def retrieve_ad_hoc_search_query_template_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _retrieve_ad_hoc_search_query_template_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/search/template',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def search_data(
        ...
        resource: Annotated[Optional[StrictStr], Field(description="resource")] = None,
        exact_match: Annotated[Optional[StrictBool], Field(description="exactMatch")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def search_data_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[GetSearchResponse]]:
        """Search Resources
