...
class PutCodesResponse(BaseModel):
    """
    PutCodesResponse
    """ # noqa: E501
    changes: Optional[PutCodesApichangesSwagger] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": PutCodesApichangesSwagger.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
