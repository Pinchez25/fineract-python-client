...
class GetAccountNumberFormatsResponseTemplate(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "prefixTypeOptions": dict(
                (_k,
                        [EnumOptionData.from_dict(_item) for _item in _v]
                        if _v is not None
                        else None
                )
                for _k, _v in obj.get("prefixTypeOptions", {}).items()
            )
        })
        return _obj
