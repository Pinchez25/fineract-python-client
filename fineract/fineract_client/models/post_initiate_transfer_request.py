...
class PostInitiateTransferRequest(BaseModel):
    """
    PostInitiateTransferRequest
    """ # noqa: E501
    date_format: Optional[StrictStr] = Field(default=None, alias="dateFormat")
    locale: Optional[StrictStr] = None
    owner_external_id: Optional[StrictStr] = Field(default=None, alias="ownerExternalId")
    ...
    __properties: ClassVar[List[str]] = ["dateFormat", "locale", "ownerExternalId", "purchasePriceRatio", "settlementDate", "transferExternalId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ownerExternalId": obj.get("ownerExternalId"),
