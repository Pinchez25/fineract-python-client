...
class PostSelfLoansData(BaseModel):
    """
    PostSelfLoansData
    """ # noqa: E501
    activation_date: Optional[StrictStr] = Field(default=None, alias="Activation_Date")
    date_format: Optional[StrictStr] = Field(default=None, alias="dateFormat")
    locale: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["Activation_Date", "dateFormat", "locale"]
