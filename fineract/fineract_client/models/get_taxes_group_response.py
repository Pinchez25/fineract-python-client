...
class GetTaxesGroupResponse(BaseModel):
    """
    GetTaxesGroupResponse
    """ # noqa: E501
    id: Optional[StrictInt] = None
    name: Optional[StrictStr] = None
    tax_associations: Optional[List[GetTaxesGroupTaxAssociations]] = Field(default=None, alias="taxAssociations")
    __properties: ClassVar[List[str]] = ["id", "name", "taxAssociations"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "taxAssociations": [GetTaxesGroupTaxAssociations.from_dict(_item) for _item in obj["taxAssociations"]] if obj.get("taxAssociations") is not None else None
        })
        return _obj
