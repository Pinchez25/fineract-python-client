...
class GetCentersCenterIdAccountsResponse(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "savingsAccounts": [GetCentersSavingsAccounts.from_dict(_item) for _item in obj["savingsAccounts"]] if obj.get("savingsAccounts") is not None else None
        })
        return _obj
