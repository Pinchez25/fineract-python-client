...
class GetAccountTransfersTemplateRefundByTransferFromOffice(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["externalId", "hierarchy", "id", "name", "nameDecorated", "openingDate"]
