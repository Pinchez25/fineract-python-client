...
class GetRecurringDepositAccountsAccountChartCurrency(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["code", "decimalPlaces", "displayLabel", "displaySymbol", "name", "nameCode"]
