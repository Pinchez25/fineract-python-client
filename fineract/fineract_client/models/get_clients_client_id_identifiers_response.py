...
class GetClientsClientIdIdentifiersResponse(BaseModel):
    """
    ...
    document_type: Optional[GetClientsDocumentType] = Field(default=None, alias="documentType")
    id: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["clientId", "description", "documentKey", "documentType", "id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "documentType": GetClientsDocumentType.from_dict(obj["documentType"]) if obj.get("documentType") is not None else None,
            "id": obj.get("id")
        })
        return _obj
