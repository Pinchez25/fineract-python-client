...
class GetLoansTemplateResponse(BaseModel):
    """
    ...
    product_options: Optional[List[GetLoansTemplateProductOptions]] = Field(default=None, alias="productOptions")
    timeline: Optional[GetLoansTemplateTimeline] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "productOptions": [GetLoansTemplateProductOptions.from_dict(_item) for _item in obj["productOptions"]] if obj.get("productOptions") is not None else None,
            "timeline": GetLoansTemplateTimeline.from_dict(obj["timeline"]) if obj.get("timeline") is not None else None
        })
        return _obj
