...
class CreditAllocationData(BaseModel):
    """
    CreditAllocationData
    """ # noqa: E501
    credit_allocation_order: Optional[List[CreditAllocationOrder]] = Field(default=None, alias="creditAllocationOrder")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "creditAllocationOrder": [CreditAllocationOrder.from_dict(_item) for _item in obj["creditAllocationOrder"]] if obj.get("creditAllocationOrder") is not None else None,
