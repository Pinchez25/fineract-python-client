...
class PutDelinquencyRangeResponse(BaseModel):
    """
    PutDelinquencyRangeResponse
    """ # noqa: E501
    changes: Optional[PostDelinquencyRangeRequest] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": PostDelinquencyRangeRequest.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
