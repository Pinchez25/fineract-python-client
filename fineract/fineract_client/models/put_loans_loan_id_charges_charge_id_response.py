...
class PutLoansLoanIdChargesChargeIdResponse(BaseModel):
    """
    PutLoansLoanIdChargesChargeIdResponse
    """ # noqa: E501
    changes: Optional[PutLoansLoanIdChargesChargeIdRequest] = None
    ...
    __properties: ClassVar[List[str]] = ["changes", "clientId", "loanId", "officeId", "resourceExternalId", "resourceId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": PutLoansLoanIdChargesChargeIdRequest.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
