...
class PutGroupsGroupIdResponse(BaseModel):
    """
    PutGroupsGroupIdResponse
    """ # noqa: E501
    changes: Optional[PutGroupsGroupIdChanges] = None
    ...
    __properties: ClassVar[List[str]] = ["changes", "groupId", "officeId", "resourceId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": PutGroupsGroupIdChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
