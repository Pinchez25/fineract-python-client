...
class PostTaxesGroupRequest(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "taxComponents": [PostTaxesGroupTaxComponents.from_dict(_item) for _item in obj["taxComponents"]] if obj.get("taxComponents") is not None else None
        })
        return _obj
