...
class GetGroupsTemplateDatatables(BaseModel):
    """
    GetGroupsTemplateDatatables
    """ # noqa: E501
    application_table_name: Optional[StrictStr] = Field(default=None, alias="applicationTableName")
    column_header_data: Optional[List[GetGroupsTemplateColumnHeaderData]] = Field(default=None, alias="columnHeaderData")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "applicationTableName": obj.get("applicationTableName"),
            "columnHeaderData": [GetGroupsTemplateColumnHeaderData.from_dict(_item) for _item in obj["columnHeaderData"]] if obj.get("columnHeaderData") is not None else None,
            "registeredTableName": obj.get("registeredTableName")
        })
        return _obj
