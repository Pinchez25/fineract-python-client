...
class PostCollectionSheetResponse(BaseModel):
    """
    PostCollectionSheetResponse
    """ # noqa: E501
    changes: Optional[PostCollectionSheetChanges] = None
    ...
    __properties: ClassVar[List[str]] = ["changes", "groupId", "resourceId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": PostCollectionSheetChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
