...
class GetUserDetailsResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["accessToken", "authenticated", "officeId", "officeName", "organisationalRole", "permissions", "roles", "staffDisplayName", "staffId", "userId", "username"]
