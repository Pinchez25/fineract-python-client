...
class PostInterestRateChartsChartIdChartSlabsRequest(BaseModel):
    """
    ...
    incentives: Optional[List[PostInterestRateChartsChartIdChartSlabsIncentives]] = None
    locale: Optional[StrictStr] = None
    period_type: Optional[StrictInt] = Field(default=None, alias="periodType")
    to_period: Optional[StrictInt] = Field(default=None, alias="toPeriod")
    __properties: ClassVar[List[str]] = ["annualInterestRate", "description", "fromPeriod", "incentives", "locale", "periodType", "toPeriod"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "incentives": [PostInterestRateChartsChartIdChartSlabsIncentives.from_dict(_item) for _item in obj["incentives"]] if obj.get("incentives") is not None else None,
