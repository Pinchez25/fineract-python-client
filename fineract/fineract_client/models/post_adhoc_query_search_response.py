...
class PostAdhocQuerySearchResponse(BaseModel):
    """
    PostAdhocQuerySearchResponse
    """ # noqa: E501
    loan_out_standing: Optional[StrictInt] = Field(default=None, alias="loanOutStanding")
    ...
    __properties: ClassVar[List[str]] = ["loanOutStanding", "loanProductName", "officeName", "percentage"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "loanOutStanding": obj.get("loanOutStanding"),
