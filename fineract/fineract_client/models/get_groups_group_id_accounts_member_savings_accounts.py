...
class GetGroupsGroupIdAccountsMemberSavingsAccounts(BaseModel):
    """
    GetGroupsGroupIdAccountsMemberSavingsAccounts
    """ # noqa: E501
    account_no: Optional[StrictInt] = Field(default=None, alias="accountNo")
    account_type: Optional[GetGroupsGroupIdAccountsMemberLoanType] = Field(default=None, alias="accountType")
    currency: Optional[GetGroupsGroupIdAccountsSavingCurrency] = None
    ...
    status: Optional[GetGroupsGroupIdAccountsSavingStatus] = None
    __properties: ClassVar[List[str]] = ["accountNo", "accountType", "currency", "id", "productId", "productName", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "accountType": GetGroupsGroupIdAccountsMemberLoanType.from_dict(obj["accountType"]) if obj.get("accountType") is not None else None,
            "currency": GetGroupsGroupIdAccountsSavingCurrency.from_dict(obj["currency"]) if obj.get("currency") is not None else None,
            "id": obj.get("id"),
            "productId": obj.get("productId"),
            "productName": obj.get("productName"),
            "status": GetGroupsGroupIdAccountsSavingStatus.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj
