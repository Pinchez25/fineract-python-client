...
class GetClientsClientIdAccountsResponse(BaseModel):
    """
    GetClientsClientIdAccountsResponse
    """ # noqa: E501
    loan_accounts: Optional[List[GetClientsLoanAccounts]] = Field(default=None, alias="loanAccounts")
    savings_accounts: Optional[List[GetClientsSavingsAccounts]] = Field(default=None, alias="savingsAccounts")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "loanAccounts": [GetClientsLoanAccounts.from_dict(_item) for _item in obj["loanAccounts"]] if obj.get("loanAccounts") is not None else None,
            "savingsAccounts": [GetClientsSavingsAccounts.from_dict(_item) for _item in obj["savingsAccounts"]] if obj.get("savingsAccounts") is not None else None
        })
        return _obj
