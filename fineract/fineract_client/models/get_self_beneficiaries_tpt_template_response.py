...
class GetSelfBeneficiariesTPTTemplateResponse(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "accountTypeOptions": [GetSelfBeneficiariesAccountOptions.from_dict(_item) for _item in obj["accountTypeOptions"]] if obj.get("accountTypeOptions") is not None else None
        })
        return _obj
