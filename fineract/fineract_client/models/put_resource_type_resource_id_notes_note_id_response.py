...
class PutResourceTypeResourceIdNotesNoteIdResponse(BaseModel):
    """
    PutResourceTypeResourceIdNotesNoteIdResponse
    """ # noqa: E501
    changes: Optional[PutNotesChanges] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": PutNotesChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
