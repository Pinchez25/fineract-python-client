...
class SavingsAccountTransactionsSearchResponse(BaseModel):
    """
    SavingsAccountTransactionsSearchResponse
    """ # noqa: E501
    content: Optional[List[GetSavingsAccountTransactionsPageItem]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "content": [GetSavingsAccountTransactionsPageItem.from_dict(_item) for _item in obj["content"]] if obj.get("content") is not None else None,
            "total": obj.get("total")
        })
        return _obj
