...
class PutFixedDepositProductsProductIdResponse(BaseModel):
    """
    PutFixedDepositProductsProductIdResponse
    """ # noqa: E501
    changes: Optional[PutFixedDepositProductsChanges] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": PutFixedDepositProductsChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
