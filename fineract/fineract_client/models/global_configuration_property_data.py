...
class GlobalConfigurationPropertyData(BaseModel):
    """
    ...
    trap_door: Optional[StrictBool] = Field(default=None, alias="trapDoor")
    value: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["dateValue", "description", "enabled", "id", "name", "stringValue", "trapDoor", "value"]
