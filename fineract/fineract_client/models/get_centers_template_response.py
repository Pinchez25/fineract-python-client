...
class GetCentersTemplateResponse(BaseModel):
    """
    ...
    office_options: Optional[List[GetCentersOfficeOptions]] = Field(default=None, alias="officeOptions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "officeOptions": [GetCentersOfficeOptions.from_dict(_item) for _item in obj["officeOptions"]] if obj.get("officeOptions") is not None else None,
            "staffOptions": [GetCentersStaffOptions.from_dict(_item) for _item in obj["staffOptions"]] if obj.get("staffOptions") is not None else None
        })
        return _obj
