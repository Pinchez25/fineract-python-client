...
class TaxComponent(BaseModel):
    ...
    credit_account_type: Optional[StrictInt] = Field(default=None, alias="creditAccountType")
    credit_acount: Optional[GLAccount] = Field(default=None, alias="creditAcount")
    debit_account_type: Optional[StrictInt] = Field(default=None, alias="debitAccountType")
    debit_acount: Optional[GLAccount] = Field(default=None, alias="debitAcount")
    ...
    tax_component_histories: Optional[List[TaxComponentHistory]] = Field(default=None, alias="taxComponentHistories")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of credit_acount
        if self.credit_acount:
            _dict['creditAcount'] = self.credit_acount.to_dict()
        # override the default output from pydantic by calling `to_dict()` of debit_acount
        if self.debit_acount:
            _dict['debitAcount'] = self.debit_acount.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "creditAccountType": obj.get("creditAccountType"),
            "creditAcount": GLAccount.from_dict(obj["creditAcount"]) if obj.get("creditAcount") is not None else None,
            "debitAccountType": obj.get("debitAccountType"),
            "debitAcount": GLAccount.from_dict(obj["debitAcount"]) if obj.get("debitAcount") is not None else None,
            "id": obj.get("id"),
            "lastModifiedBy": obj.get("lastModifiedBy"),
            "lastModifiedDate": obj.get("lastModifiedDate"),
            "new": obj.get("new"),
            "percentage": obj.get("percentage"),
            "taxComponentHistories": [TaxComponentHistory.from_dict(_item) for _item in obj["taxComponentHistories"]] if obj.get("taxComponentHistories") is not None else None,
...
TaxComponent.model_rebuild(raise_errors=False)
