...
class GetFixedDepositProductsResponse(BaseModel):
    """
    GetFixedDepositProductsResponse
    """ # noqa: E501
    accounting_rule: Optional[GetFixedDepositProductsAccountingRule] = Field(default=None, alias="accountingRule")
    currency: Optional[GetFixedDepositProductsCurrency] = None
    ...
    interest_compounding_period_type: Optional[GetFixedDepositProductsInterestCompoundingPeriodType] = Field(default=None, alias="interestCompoundingPeriodType")
    ...
    max_deposit_term_type: Optional[GetFixedDepositProductsMaxDepositTermType] = Field(default=None, alias="maxDepositTermType")
    min_deposit_term: Optional[StrictInt] = Field(default=None, alias="minDepositTerm")
    min_deposit_term_type: Optional[GetFixedDepositProductsMinDepositTermType] = Field(default=None, alias="minDepositTermType")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "accountingRule": GetFixedDepositProductsAccountingRule.from_dict(obj["accountingRule"]) if obj.get("accountingRule") is not None else None,
            "currency": GetFixedDepositProductsCurrency.from_dict(obj["currency"]) if obj.get("currency") is not None else None,
            ...
            "interestCompoundingPeriodType": GetFixedDepositProductsInterestCompoundingPeriodType.from_dict(obj["interestCompoundingPeriodType"]) if obj.get("interestCompoundingPeriodType") is not None else None,
            ...
            "maxDepositTermType": GetFixedDepositProductsMaxDepositTermType.from_dict(obj["maxDepositTermType"]) if obj.get("maxDepositTermType") is not None else None,
            "minDepositTerm": obj.get("minDepositTerm"),
            "minDepositTermType": GetFixedDepositProductsMinDepositTermType.from_dict(obj["minDepositTermType"]) if obj.get("minDepositTermType") is not None else None,
            "name": obj.get("name"),
