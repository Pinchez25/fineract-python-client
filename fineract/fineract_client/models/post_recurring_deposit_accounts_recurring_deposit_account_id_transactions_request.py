...
class PostRecurringDepositAccountsRecurringDepositAccountIdTransactionsRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["accountNumber", "bankNumber", "checkNumber", "dateFormat", "locale", "paymentTypeId", "receiptNumber", "routingCode", "transactionAmount", "transactionDate"]
