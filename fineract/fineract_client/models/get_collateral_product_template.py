...
class GetCollateralProductTemplate(BaseModel):
    """
    GetCollateralProductTemplate
    """ # noqa: E501
    currency: Optional[GetCurrencyData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "currency": GetCurrencyData.from_dict(obj["currency"]) if obj.get("currency") is not None else None
        })
        return _obj
