...
class GetReportMailingJobsTemplate(BaseModel):
    """
    GetReportMailingJobsTemplate
    """ # noqa: E501
    email_attachment_file_format_options: Optional[List[EnumOptionData]] = Field(default=None, alias="emailAttachmentFileFormatOptions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "emailAttachmentFileFormatOptions": [EnumOptionData.from_dict(_item) for _item in obj["emailAttachmentFileFormatOptions"]] if obj.get("emailAttachmentFileFormatOptions") is not None else None,
            "isActive": obj.get("isActive"),
            "stretchyReportParamDateOptions": [EnumOptionData.from_dict(_item) for _item in obj["stretchyReportParamDateOptions"]] if obj.get("stretchyReportParamDateOptions") is not None else None
        })
        return _obj
