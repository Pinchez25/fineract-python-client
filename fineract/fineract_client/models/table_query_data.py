...
class TableQueryData(BaseModel):
    """
    TableQueryData
    """ # noqa: E501
    query: Optional[AdvancedQueryData] = None
    table: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["query", "table"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "query": AdvancedQueryData.from_dict(obj["query"]) if obj.get("query") is not None else None,
            "table": obj.get("table")
        })
        return _obj
