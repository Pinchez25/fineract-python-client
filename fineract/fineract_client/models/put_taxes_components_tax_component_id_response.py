...
class PutTaxesComponentsTaxComponentIdResponse(BaseModel):
    """
    PutTaxesComponentsTaxComponentIdResponse
    """ # noqa: E501
    changes: Optional[PutTaxesComponentsChanges] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": PutTaxesComponentsChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
