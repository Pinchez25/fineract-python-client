...
class PostClientsAddressRequest(BaseModel):
    """
    Address requests
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["addressLine1", "addressLine2", "addressLine3", "addressTypeId", "city", "countryId", "isActive", "postalCode", "stateProvinceId", "street"]
