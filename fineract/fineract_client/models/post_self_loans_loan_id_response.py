...
class PostSelfLoansLoanIdResponse(BaseModel):
    """
    PostSelfLoansLoanIdResponse
    """ # noqa: E501
    changes: Optional[PostSelfLoansLoanIdChanges] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": PostSelfLoansLoanIdChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
