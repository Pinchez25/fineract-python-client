...
class GetClientsDataTables(BaseModel):
    """
    GetClientsDataTables
    """ # noqa: E501
    application_table_name: Optional[StrictStr] = Field(default=None, alias="applicationTableName")
    column_header_data: Optional[List[GetClientsColumnHeaderData]] = Field(default=None, alias="columnHeaderData")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "columnHeaderData": [GetClientsColumnHeaderData.from_dict(_item) for _item in obj["columnHeaderData"]] if obj.get("columnHeaderData") is not None else None,
