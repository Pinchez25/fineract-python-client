...
class GetSavingsAccountsSavingsAccountIdChargesSavingsAccountChargeIdResponse(BaseModel):
    """
    ...
    charge_time_type: Optional[GetChargesChargeTimeType] = Field(default=None, alias="chargeTimeType")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "chargeTimeType": GetChargesChargeTimeType.from_dict(obj["chargeTimeType"]) if obj.get("chargeTimeType") is not None else None,
