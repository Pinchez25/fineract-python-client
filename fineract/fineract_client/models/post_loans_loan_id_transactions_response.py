...
class PostLoansLoanIdTransactionsResponse(BaseModel):
    """
    PostLoansLoanIdTransactionsResponse
    """ # noqa: E501
    changes: Optional[PostLoansLoanIdTransactionsResponseChanges] = None
    ...
    sub_resource_external_id: Optional[StrictStr] = Field(default=None, alias="subResourceExternalId")
    sub_resource_id: Optional[StrictInt] = Field(default=None, alias="subResourceId")
    __properties: ClassVar[List[str]] = ["changes", "clientId", "loanId", "officeId", "resourceExternalId", "resourceId", "subResourceExternalId", "subResourceId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": PostLoansLoanIdTransactionsResponseChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
