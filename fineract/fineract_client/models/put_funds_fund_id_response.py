...
class PutFundsFundIdResponse(BaseModel):
    """
    PutFundsFundIdResponse
    """ # noqa: E501
    changes: Optional[PutFundsFundIdRequest] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": PutFundsFundIdRequest.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
