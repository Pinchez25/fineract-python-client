...
class PostProductsMarketPricePeriods(BaseModel):
    """
    ...
    share_value: Optional[StrictInt] = Field(default=None, alias="shareValue")
    __properties: ClassVar[List[str]] = ["dateFormat", "fromDate", "locale", "shareValue"]
