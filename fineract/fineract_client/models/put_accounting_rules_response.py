...
class PutAccountingRulesResponse(BaseModel):
    """
    PutAccountingRulesResponse
    """ # noqa: E501
    changes: Optional[PutAccountingRulesResponsechangesSwagger] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": PutAccountingRulesResponsechangesSwagger.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
