...
class PostSavingsProductsRequest(BaseModel):
    """
    PostSavingsProductsRequest
    """ # noqa: E501
    account_mapping_for_payment: Optional[StrictStr] = Field(default=None, alias="accountMappingForPayment")
    accounting_rule: Optional[StrictInt] = Field(default=None, alias="accountingRule")
    charges: Optional[List[PostSavingsCharges]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "accountMappingForPayment": obj.get("accountMappingForPayment"),
            "accountingRule": obj.get("accountingRule"),
            "charges": [PostSavingsCharges.from_dict(_item) for _item in obj["charges"]] if obj.get("charges") is not None else None,
