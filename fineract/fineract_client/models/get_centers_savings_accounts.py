...
class GetCentersSavingsAccounts(BaseModel):
    """
    GetCentersSavingsAccounts
    """ # noqa: E501
    account_no: Optional[StrictInt] = Field(default=None, alias="accountNo")
    account_type: Optional[GetCentersAccountType] = Field(default=None, alias="accountType")
    currency: Optional[GetCentersCenterIdCurrency] = None
    deposit_type: Optional[GetCentersDepositType] = Field(default=None, alias="depositType")
    ...
    status: Optional[GetCentersCenterIdStatus] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "accountType": GetCentersAccountType.from_dict(obj["accountType"]) if obj.get("accountType") is not None else None,
            "currency": GetCentersCenterIdCurrency.from_dict(obj["currency"]) if obj.get("currency") is not None else None,
            "depositType": GetCentersDepositType.from_dict(obj["depositType"]) if obj.get("depositType") is not None else None,
            "id": obj.get("id"),
            "productId": obj.get("productId"),
            "productName": obj.get("productName"),
            "status": GetCentersCenterIdStatus.from_dict(obj["status"]) if obj.get("status") is not None else None,
            "timeline": GetCentersTimeline.from_dict(obj["timeline"]) if obj.get("timeline") is not None else None
        })
        return _obj
