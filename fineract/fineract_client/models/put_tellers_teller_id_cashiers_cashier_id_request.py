...
class PutTellersTellerIdCashiersCashierIdRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["dateFormat", "description", "endDate", "isFullDay", "locale", "staffId", "startDate"]
