...
class GetFixedDepositAccountsResponse(BaseModel):
    """
    ...
    currency: Optional[GetFixedDepositAccountsCurrency] = None
    ...
    summary: Optional[GetFixedDepositAccountsSummary] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "currency": GetFixedDepositAccountsCurrency.from_dict(obj["currency"]) if obj.get("currency") is not None else None,
            ...
            "summary": GetFixedDepositAccountsSummary.from_dict(obj["summary"]) if obj.get("summary") is not None else None,
