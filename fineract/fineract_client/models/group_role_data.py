...
class GroupRoleData(BaseModel):
    ...
    role: Optional[CodeValueData] = None
    __properties: ClassVar[List[str]] = ["clientId", "clientName", "id", "role"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "role": CodeValueData.from_dict(obj["role"]) if obj.get("role") is not None else None
        })
        return _obj
