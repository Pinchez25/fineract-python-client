...
class GetSavingsProductsPaymentChannelToFundSourceMappings(BaseModel):
    """
    GetSavingsProductsPaymentChannelToFundSourceMappings
    """ # noqa: E501
    fund_source_account: Optional[GetSavingsProductsFundSourceAccount] = Field(default=None, alias="fundSourceAccount")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "fundSourceAccount": GetSavingsProductsFundSourceAccount.from_dict(obj["fundSourceAccount"]) if obj.get("fundSourceAccount") is not None else None,
            "paymentType": GetSavingsProductsPaymentType.from_dict(obj["paymentType"]) if obj.get("paymentType") is not None else None
        })
        return _obj
