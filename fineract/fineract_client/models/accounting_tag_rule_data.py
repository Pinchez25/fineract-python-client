...
class AccountingTagRuleData(BaseModel):
    """
    AccountingTagRuleData
    """ # noqa: E501
    id: Optional[StrictInt] = None
    tag: Optional[CodeValueData] = None
    transaction_type: Optional[EnumOptionData] = Field(default=None, alias="transactionType")
    __properties: ClassVar[List[str]] = ["id", "tag", "transactionType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "tag": CodeValueData.from_dict(obj["tag"]) if obj.get("tag") is not None else None,
            "transactionType": EnumOptionData.from_dict(obj["transactionType"]) if obj.get("transactionType") is not None else None
        })
        return _obj
