...
class GetSelfBeneficiariesTPTResponse(BaseModel):
    """
    GetSelfBeneficiariesTPTResponse
    """ # noqa: E501
    account_number: Optional[StrictInt] = Field(default=None, alias="accountNumber")
    account_type: Optional[GetSelfBeneficiariesAccountOptions] = Field(default=None, alias="accountType")
    ...
    transfer_limit: Optional[StrictInt] = Field(default=None, alias="transferLimit")
    __properties: ClassVar[List[str]] = ["accountNumber", "accountType", "clientName", "id", "name", "officeName", "transferLimit"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "accountType": GetSelfBeneficiariesAccountOptions.from_dict(obj["accountType"]) if obj.get("accountType") is not None else None,
            "clientName": obj.get("clientName"),
            "id": obj.get("id"),
            "name": obj.get("name"),
            "officeName": obj.get("officeName"),
            "transferLimit": obj.get("transferLimit")
        })
        return _obj
