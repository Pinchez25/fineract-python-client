...
class PostGroupsGroupIdRequest(BaseModel):
    """
    PostGroupsGroupIdRequest
    """ # noqa: E501
    clients: Optional[List[PostGroupsGroupIdClients]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "clients": [PostGroupsGroupIdClients.from_dict(_item) for _item in obj["clients"]] if obj.get("clients") is not None else None,
            "destinationGroupId": obj.get("destinationGroupId")
        })
        return _obj
