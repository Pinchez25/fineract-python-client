...
class GetSavingsProductsChargeOptions(BaseModel):
    """
    GetSavingsProductsChargeOptions
    """ # noqa: E501
    active: Optional[StrictBool] = None
    amount: Optional[StrictInt] = None
    charge_applies_to: Optional[GetSavingsProductsChargeAppliesTo] = Field(default=None, alias="chargeAppliesTo")
    charge_calculation_type: Optional[GetSavingsChargeCalculationType] = Field(default=None, alias="chargeCalculationType")
    charge_payment_mode: Optional[GetSavingsChargePaymentMode] = Field(default=None, alias="chargePaymentMode")
    charge_time_type: Optional[GetSavingsChargeTimeType] = Field(default=None, alias="chargeTimeType")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "chargeAppliesTo": GetSavingsProductsChargeAppliesTo.from_dict(obj["chargeAppliesTo"]) if obj.get("chargeAppliesTo") is not None else None,
            "chargeCalculationType": GetSavingsChargeCalculationType.from_dict(obj["chargeCalculationType"]) if obj.get("chargeCalculationType") is not None else None,
            "chargePaymentMode": GetSavingsChargePaymentMode.from_dict(obj["chargePaymentMode"]) if obj.get("chargePaymentMode") is not None else None,
            "chargeTimeType": GetSavingsChargeTimeType.from_dict(obj["chargeTimeType"]) if obj.get("chargeTimeType") is not None else None,
