...
class TransactionDetailData(BaseModel):
    ...
    """ # noqa: E501
    note_data: Optional[NoteData] = Field(default=None, alias="noteData")
    payment_details: Optional[PaymentDetailData] = Field(default=None, alias="paymentDetails")
    transaction_id: Optional[StrictInt] = Field(default=None, alias="transactionId")
    transaction_type: Optional[TransactionTypeEnumData] = Field(default=None, alias="transactionType")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of note_data
        if self.note_data:
            _dict['noteData'] = self.note_data.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "noteData": NoteData.from_dict(obj["noteData"]) if obj.get("noteData") is not None else None,
            "paymentDetails": PaymentDetailData.from_dict(obj["paymentDetails"]) if obj.get("paymentDetails") is not None else None,
            "transactionId": obj.get("transactionId"),
            "transactionType": TransactionTypeEnumData.from_dict(obj["transactionType"]) if obj.get("transactionType") is not None else None
        })
        return _obj
