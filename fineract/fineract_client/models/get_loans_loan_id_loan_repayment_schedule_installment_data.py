...
class GetLoansLoanIdLoanRepaymentScheduleInstallmentData(BaseModel):
    """
    ...
    installment_id: Optional[StrictInt] = Field(default=None, alias="installmentId")
    __properties: ClassVar[List[str]] = ["amount", "date", "id", "installmentId"]
