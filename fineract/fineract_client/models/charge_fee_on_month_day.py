...
class ChargeFeeOnMonthDay(BaseModel):
    """
    ChargeFeeOnMonthDay
    """ # noqa: E501
    day_of_month: Optional[StrictInt] = Field(default=None, alias="dayOfMonth")
    month: Optional[StrictStr] = None
    month_value: Optional[StrictInt] = Field(default=None, alias="monthValue")
    __properties: ClassVar[List[str]] = ["dayOfMonth", "month", "monthValue"]
