...
class GetCentersCenterIdResponse(BaseModel):
    """
    ...
    status: Optional[GetCentersStatus] = None
    __properties: ClassVar[List[str]] = ["active", "hierarchy", "id", "name", "officeId", "officeName", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "status": GetCentersStatus.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj
