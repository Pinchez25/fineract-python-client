...
class GetSelfLoansLoanIdTransactionsTransactionIdResponse(BaseModel):
    """
    ...
    type: Optional[GetSelfLoansLoanIdTransactionsType] = None
    __properties: ClassVar[List[str]] = ["amount", "currency", "date", "id", "interestPortion", "manuallyReversed", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": GetSelfLoansLoanIdTransactionsType.from_dict(obj["type"]) if obj.get("type") is not None else None
        })
        return _obj
