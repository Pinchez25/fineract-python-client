...
class GetSelfSavingsAccountsAccountIdChargesSavingsAccountChargeIdResponse(BaseModel):
    """
    GetSelfSavingsAccountsAccountIdChargesSavingsAccountChargeIdResponse
    """ # noqa: E501
    amount: Optional[StrictInt] = None
    amount_or_percentage: Optional[StrictInt] = Field(default=None, alias="amountOrPercentage")
    amount_outstanding: Optional[StrictInt] = Field(default=None, alias="amountOutstanding")
    ...
    amount_waived: Optional[StrictInt] = Field(default=None, alias="amountWaived")
    amount_written_off: Optional[StrictInt] = Field(default=None, alias="amountWrittenOff")
    charge_calculation_type: Optional[GetSelfSavingsChargeCalculationType] = Field(default=None, alias="chargeCalculationType")
    charge_id: Optional[StrictInt] = Field(default=None, alias="chargeId")
    charge_time_type: Optional[GetSelfSavingsChargeTimeType] = Field(default=None, alias="chargeTimeType")
    ...
    __properties: ClassVar[List[str]] = ["amount", "amountOrPercentage", "amountOutstanding", "amountPaid", "amountPercentageAppliedTo", "amountWaived", "amountWrittenOff", "chargeCalculationType", "chargeId", "chargeTimeType", "currency", "id", "name", "penalty", "percentage"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "chargeCalculationType": GetSelfSavingsChargeCalculationType.from_dict(obj["chargeCalculationType"]) if obj.get("chargeCalculationType") is not None else None,
            "chargeId": obj.get("chargeId"),
            "chargeTimeType": GetSelfSavingsChargeTimeType.from_dict(obj["chargeTimeType"]) if obj.get("chargeTimeType") is not None else None,
