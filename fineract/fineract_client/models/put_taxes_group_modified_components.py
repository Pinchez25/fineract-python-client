...
class PutTaxesGroupModifiedComponents(BaseModel):
    """
    PutTaxesGroupModifiedComponents
    """ # noqa: E501
    end_date: Optional[StrictStr] = Field(default=None, alias="endDate")
    tax_component_id: Optional[StrictInt] = Field(default=None, alias="taxComponentId")
    __properties: ClassVar[List[str]] = ["endDate", "taxComponentId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "taxComponentId": obj.get("taxComponentId")
        })
        return _obj
