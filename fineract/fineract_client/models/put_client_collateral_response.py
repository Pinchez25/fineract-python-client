...
class PutClientCollateralResponse(BaseModel):
    """
    PutClientCollateralResponse
    """ # noqa: E501
    changes: Optional[PutClientCollateralRequest] = None
    ...
    __properties: ClassVar[List[str]] = ["changes", "clientId", "resourceId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": PutClientCollateralRequest.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
