...
class PutTaxesGroupTaxGroupIdResponse(BaseModel):
    """
    PutTaxesGroupTaxGroupIdResponse
    """ # noqa: E501
    changes: Optional[PutTaxesGroupChanges] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": PutTaxesGroupChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
