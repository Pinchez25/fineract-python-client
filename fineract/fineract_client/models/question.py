...
class Question(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["componentKey", "description", "id", "key", "new", "responses", "sequenceNo", "survey", "text"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "key": obj.get("key"),
            "new": obj.get("new"),
            "responses": [Response.from_dict(_item) for _item in obj["responses"]] if obj.get("responses") is not None else None,
...
Question.model_rebuild(raise_errors=False)
