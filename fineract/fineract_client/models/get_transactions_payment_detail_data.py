...
class GetTransactionsPaymentDetailData(BaseModel):
    """
    ...
    payment_type: Optional[GetPaymentTypeData] = Field(default=None, alias="paymentType")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "paymentType": GetPaymentTypeData.from_dict(obj["paymentType"]) if obj.get("paymentType") is not None else None,
