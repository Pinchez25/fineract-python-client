...
class GetLoansLoanIdDisbursementDetails(BaseModel):
    """
    ...
    loan_charge_id: Optional[StrictStr] = Field(default=None, alias="loanChargeId")
    ...
    waived_charge_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="waivedChargeAmount")
    __properties: ClassVar[List[str]] = ["actualDisbursementDate", "approvedPrincipal", "chargeAmount", "dateFormat", "expectedDisbursementDate", "id", "loanChargeId", "locale", "netDisbursalAmount", "note", "principal", "waivedChargeAmount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "loanChargeId": obj.get("loanChargeId"),
            "locale": obj.get("locale"),
            "netDisbursalAmount": obj.get("netDisbursalAmount"),
            "note": obj.get("note"),
            "principal": obj.get("principal"),
            "waivedChargeAmount": obj.get("waivedChargeAmount")
        })
        return _obj
