...
class PutRolesRoleIdPermissionsResponse(BaseModel):
    """
    PutRolesRoleIdPermissionsResponse
    """ # noqa: E501
    changes: Optional[PutRolesRoleIdPermissionsResponsePermissionsChanges] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": PutRolesRoleIdPermissionsResponsePermissionsChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
