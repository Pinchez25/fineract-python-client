...
class PutCodeValueDataResponse(BaseModel):
    """
    PutCodeValueDataResponse
    """ # noqa: E501
    changes: Optional[PutCodeValuechangesSwagger] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": PutCodeValuechangesSwagger.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
