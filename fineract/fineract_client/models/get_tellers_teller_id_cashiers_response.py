...
class GetTellersTellerIdCashiersResponse(BaseModel):
    """
    GetTellersTellerIdCashiersResponse
    """ # noqa: E501
    cashiers: Optional[List[CashierData]] = None
    ...
    __properties: ClassVar[List[str]] = ["cashiers", "officeId", "officeName", "tellerId", "tellerName"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in cashiers (list)
        _items = []
        if self.cashiers:
            for _item in self.cashiers:
                if _item:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cashiers": [CashierData.from_dict(_item) for _item in obj["cashiers"]] if obj.get("cashiers") is not None else None,
