...
class PutOfficesOfficeIdRequest(BaseModel):
    """
    ...
    opening_date: Optional[StrictStr] = Field(default=None, alias="openingDate")
    __properties: ClassVar[List[str]] = ["dateFormat", "externalId", "locale", "name", "openingDate"]
