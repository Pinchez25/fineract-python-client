...
class PutAccountNumberFormatsResponse(BaseModel):
    """
    PutAccountNumberFormatsResponse
    """ # noqa: E501
    changes: Optional[PutAccountNumberFormatschangesSwagger] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": PutAccountNumberFormatschangesSwagger.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
