...
class PageJournalEntryData(BaseModel):
    """
    PageJournalEntryData
    """ # noqa: E501
    content: Optional[List[JournalEntryData]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "content": [JournalEntryData.from_dict(_item) for _item in obj["content"]] if obj.get("content") is not None else None,
            "empty": obj.get("empty"),
            "first": obj.get("first"),
            "last": obj.get("last"),
