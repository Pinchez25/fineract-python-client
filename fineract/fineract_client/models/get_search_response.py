...
class GetSearchResponse(BaseModel):
    ...
    GetSearchResponse
    """ # noqa: E501
    entity_account_no: Optional[StrictInt] = Field(default=None, alias="entityAccountNo")
    entity_external_id: Optional[StrictStr] = Field(default=None, alias="entityExternalId")
    ...
    entity_status: Optional[EnumOptionData] = Field(default=None, alias="entityStatus")
    ...
    __properties: ClassVar[List[str]] = ["entityAccountNo", "entityExternalId", "entityId", "entityName", "entityStatus", "entityType", "parentId", "parentName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entityAccountNo": obj.get("entityAccountNo"),
            "entityExternalId": obj.get("entityExternalId"),
            "entityId": obj.get("entityId"),
            "entityName": obj.get("entityName"),
            "entityStatus": EnumOptionData.from_dict(obj["entityStatus"]) if obj.get("entityStatus") is not None else None,
