...
class PutLoansLoanIdDisbursementData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["dateFormat", "expectedDisbursementDate", "interestType", "isEqualAmortization", "locale", "netDisbursalAmount", "principal"]
