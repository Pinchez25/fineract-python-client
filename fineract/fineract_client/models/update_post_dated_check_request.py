...
class UpdatePostDatedCheckRequest(BaseModel):
    """
    ...
    repayment_date: Optional[date] = Field(default=None, alias="repaymentDate")
    __properties: ClassVar[List[str]] = ["accountNo", "amount", "date", "dateFormat", "locale", "name", "repaymentDate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "repaymentDate": obj.get("repaymentDate")
        })
        return _obj
