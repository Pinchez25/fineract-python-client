...
class GetSelfSavingsAccountsAccountIdTransactionsTransactionIdResponse(BaseModel):
    """
    ...
    currency: Optional[GetSelfSavingsTransactionCurrency] = None
    var_date: Optional[date] = Field(default=None, alias="date")
    id: Optional[StrictInt] = None
    payment_detail_data: Optional[GetSelfSavingsPaymentDetailData] = Field(default=None, alias="paymentDetailData")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "currency": GetSelfSavingsTransactionCurrency.from_dict(obj["currency"]) if obj.get("currency") is not None else None,
            "date": obj.get("date"),
            "id": obj.get("id"),
            "paymentDetailData": GetSelfSavingsPaymentDetailData.from_dict(obj["paymentDetailData"]) if obj.get("paymentDetailData") is not None else None,
            "reversed": obj.get("reversed"),
            "runningBalance": obj.get("runningBalance"),
            "transactionType": GetSelfSavingsTransactionType.from_dict(obj["transactionType"]) if obj.get("transactionType") is not None else None
        })
        return _obj
