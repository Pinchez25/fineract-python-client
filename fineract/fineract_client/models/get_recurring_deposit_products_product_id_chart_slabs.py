...
class GetRecurringDepositProductsProductIdChartSlabs(BaseModel):
    """
    ...
    period_type: Optional[GetRecurringDepositProductsProductIdPeriodType] = Field(default=None, alias="periodType")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "periodType": GetRecurringDepositProductsProductIdPeriodType.from_dict(obj["periodType"]) if obj.get("periodType") is not None else None,
