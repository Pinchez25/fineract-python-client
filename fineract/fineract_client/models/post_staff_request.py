...
class PostStaffRequest(BaseModel):
    """
    PostStaffRequest
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["dateFormat", "externalId", "firstname", "isActive", "isLoanOfficer", "joiningDate", "lastname", "locale", "mobileNo", "officeId"]
