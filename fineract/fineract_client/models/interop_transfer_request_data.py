...
class InteropTransferRequestData(BaseModel):
    """
    ...
    transfer_code: StrictStr = Field(alias="transferCode")
    __properties: ClassVar[List[str]] = ["accountId", "amount", "expiration", "expirationLocalDate", "extensionList", "fspCommission", "fspFee", "geoCode", "note", "requestCode", "transactionCode", "transactionRole", "transactionType", "transferCode"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "transferCode": obj.get("transferCode")
        })
        return _obj
