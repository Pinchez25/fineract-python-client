...
class GetClientsResponse(BaseModel):
    ...
    GetClientsResponse
    """ # noqa: E501
    page_items: Optional[List[GetClientsPageItemsResponse]] = Field(default=None, alias="pageItems")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pageItems": [GetClientsPageItemsResponse.from_dict(_item) for _item in obj["pageItems"]] if obj.get("pageItems") is not None else None,
