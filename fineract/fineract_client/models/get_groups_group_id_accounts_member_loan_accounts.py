...
class GetGroupsGroupIdAccountsMemberLoanAccounts(BaseModel):
    """
    GetGroupsGroupIdAccountsMemberLoanAccounts
    """ # noqa: E501
    account_no: Optional[StrictInt] = Field(default=None, alias="accountNo")
    id: Optional[StrictInt] = None
    loan_type: Optional[GetGroupsGroupIdAccountsMemberLoanType] = Field(default=None, alias="loanType")
    ...
    status: Optional[GetGroupsGroupIdAccountsMemberLoanStatus] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "loanType": GetGroupsGroupIdAccountsMemberLoanType.from_dict(obj["loanType"]) if obj.get("loanType") is not None else None,
            "productId": obj.get("productId"),
            "productName": obj.get("productName"),
            "status": GetGroupsGroupIdAccountsMemberLoanStatus.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj
