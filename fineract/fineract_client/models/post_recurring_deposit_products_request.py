...
class PostRecurringDepositProductsRequest(BaseModel):
    """
    PostRecurringDepositProductsRequest
    """ # noqa: E501
    accounting_rule: Optional[StrictInt] = Field(default=None, alias="accountingRule")
    charts: Optional[List[PostRecurringDepositProductsCharts]] = None
    currency_code: Optional[StrictStr] = Field(default=None, alias="currencyCode")
    deposit_amount: Optional[StrictInt] = Field(default=None, alias="depositAmount")
    ...
    max_deposit_amount: Optional[StrictInt] = Field(default=None, alias="maxDepositAmount")
    ...
    min_deposit_amount: Optional[StrictInt] = Field(default=None, alias="minDepositAmount")
    ...
    recurring_deposit_frequency_type_id: Optional[StrictInt] = Field(default=None, alias="recurringDepositFrequencyTypeId")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "charts": [PostRecurringDepositProductsCharts.from_dict(_item) for _item in obj["charts"]] if obj.get("charts") is not None else None,
            ...
            "recurringDepositFrequencyTypeId": obj.get("recurringDepositFrequencyTypeId"),
