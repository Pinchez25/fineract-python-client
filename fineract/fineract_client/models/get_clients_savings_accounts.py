...
class GetClientsSavingsAccounts(BaseModel):
    """
    GetClientsSavingsAccounts
    """ # noqa: E501
    account_no: Optional[StrictStr] = Field(default=None, alias="accountNo")
    currency: Optional[GetClientsSavingsAccountsCurrency] = None
    deposit_type: Optional[GetClientsSavingsAccountsDepositType] = Field(default=None, alias="depositType")
    ...
    status: Optional[GetClientsSavingsAccountsStatus] = None
    __properties: ClassVar[List[str]] = ["accountNo", "currency", "depositType", "id", "productId", "productName", "shortProductName", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "currency": GetClientsSavingsAccountsCurrency.from_dict(obj["currency"]) if obj.get("currency") is not None else None,
            "depositType": GetClientsSavingsAccountsDepositType.from_dict(obj["depositType"]) if obj.get("depositType") is not None else None,
            "id": obj.get("id"),
            "productId": obj.get("productId"),
            "productName": obj.get("productName"),
            "shortProductName": obj.get("shortProductName"),
            "status": GetClientsSavingsAccountsStatus.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj
