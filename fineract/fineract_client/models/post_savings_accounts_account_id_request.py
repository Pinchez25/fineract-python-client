...
class PostSavingsAccountsAccountIdRequest(BaseModel):
    """
    PostSavingsAccountsAccountIdRequest
    """ # noqa: E501
    activated_on_date: Optional[StrictStr] = Field(default=None, alias="activatedOnDate")
    ...
    __properties: ClassVar[List[str]] = ["activatedOnDate", "approvedOnDate", "dateFormat", "locale"]
