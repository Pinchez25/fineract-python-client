...
class GetAccountTransfersTemplateRefundByTransferFromAccountOptions(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["accountNo", "clientId", "clientName", "currency", "fieldOfficerId", "id", "productId", "productName"]
