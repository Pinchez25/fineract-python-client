...
class PutCollateralProductResponse(BaseModel):
    """
    PutCollateralProductResponse
    """ # noqa: E501
    changes: Optional[PutCollateralProductRequest] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": PutCollateralProductRequest.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
