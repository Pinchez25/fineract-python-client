...
class GetExternalEventConfigurationsResponse(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "externalEventConfiguration": [ExternalEventConfigurationItemData.from_dict(_item) for _item in obj["externalEventConfiguration"]] if obj.get("externalEventConfiguration") is not None else None
        })
        return _obj
