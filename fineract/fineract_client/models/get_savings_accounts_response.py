...
class GetSavingsAccountsResponse(BaseModel):
    """
    GetSavingsAccountsResponse
    """ # noqa: E501
    page_items: Optional[List[GetSavingsPageItems]] = Field(default=None, alias="pageItems")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pageItems": [GetSavingsPageItems.from_dict(_item) for _item in obj["pageItems"]] if obj.get("pageItems") is not None else None,
