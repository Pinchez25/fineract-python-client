...
class RunReportsResponse(BaseModel):
    ...
    RunReportsResponse
    """ # noqa: E501
    column_headers: Optional[List[ResultsetColumnHeaderData]] = Field(default=None, alias="columnHeaders")
    data: Optional[List[ResultsetRowData]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "columnHeaders": [ResultsetColumnHeaderData.from_dict(_item) for _item in obj["columnHeaders"]] if obj.get("columnHeaders") is not None else None,
            "data": [ResultsetRowData.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
