...
class PutSavingsAccountsSavingsAccountIdChargesSavingsAccountChargeIdResponse(BaseModel):
    """
    PutSavingsAccountsSavingsAccountIdChargesSavingsAccountChargeIdResponse
    """ # noqa: E501
    changes: Optional[PutSavingsChanges] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": PutSavingsChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
