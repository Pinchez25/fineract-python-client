...
class PutHookResponse(BaseModel):
    """
    PutHookResponse
    """ # noqa: E501
    changes: Optional[PutHookResponseChangesSwagger] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": PutHookResponseChangesSwagger.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
