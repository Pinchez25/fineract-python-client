...
class PutRecurringDepositProductsResponse(BaseModel):
    """
    PutRecurringDepositProductsResponse
    """ # noqa: E501
    changes: Optional[PutRecurringDepositProductsChanges] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": PutRecurringDepositProductsChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
