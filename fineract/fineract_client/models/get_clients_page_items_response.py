...
class GetClientsPageItemsResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["accountNo", "active", "displayName", "emailAddress", "fullname", "id", "officeId", "officeName", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "status": GetClientStatus.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj
