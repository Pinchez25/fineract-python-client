...
class GetLoansApprovalTemplateResponse(BaseModel):
    """
    GetLoansApprovalTemplateResponse
    """ # noqa: E501
    approval_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="approvalAmount")
    ...
    __properties: ClassVar[List[str]] = ["approvalAmount", "approvalDate", "currency", "netDisbursalAmount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "approvalAmount": obj.get("approvalAmount"),
