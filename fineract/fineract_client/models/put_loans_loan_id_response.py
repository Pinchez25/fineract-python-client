...
class PutLoansLoanIdResponse(BaseModel):
    """
    PutLoansLoanIdResponse
    """ # noqa: E501
    changes: Optional[PutLoansLoanIdChanges] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": PutLoansLoanIdChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
