...
class GetRecurringDepositAccountsRecurringDepositAccountIdTransactionsTemplateResponse(BaseModel):
    """
    ...
    currency: Optional[GetRecurringCurrency] = None
    var_date: Optional[date] = Field(default=None, alias="date")
    id: Optional[StrictInt] = None
    payment_type_options: Optional[List[StrictInt]] = Field(default=None, alias="paymentTypeOptions")
    reversed: Optional[StrictBool] = None
    transaction_type: Optional[GetRecurringTransactionType] = Field(default=None, alias="transactionType")
    __properties: ClassVar[List[str]] = ["accountId", "accountNo", "amount", "currency", "date", "id", "paymentTypeOptions", "reversed", "transactionType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "currency": GetRecurringCurrency.from_dict(obj["currency"]) if obj.get("currency") is not None else None,
            "date": obj.get("date"),
            "id": obj.get("id"),
            "paymentTypeOptions": obj.get("paymentTypeOptions"),
            "reversed": obj.get("reversed"),
            "transactionType": GetRecurringTransactionType.from_dict(obj["transactionType"]) if obj.get("transactionType") is not None else None
        })
        return _obj
