...
class GetSelfLoansLoanIdChargesResponse(BaseModel):
    """
    ...
    charge_calculation_type: Optional[GetSelfLoansChargeCalculationType] = Field(default=None, alias="chargeCalculationType")
    charge_id: Optional[StrictInt] = Field(default=None, alias="chargeId")
    charge_time_type: Optional[GetSelfLoansChargeTimeType] = Field(default=None, alias="chargeTimeType")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "chargeCalculationType": GetSelfLoansChargeCalculationType.from_dict(obj["chargeCalculationType"]) if obj.get("chargeCalculationType") is not None else None,
            "chargeId": obj.get("chargeId"),
            "chargeTimeType": GetSelfLoansChargeTimeType.from_dict(obj["chargeTimeType"]) if obj.get("chargeTimeType") is not None else None,
