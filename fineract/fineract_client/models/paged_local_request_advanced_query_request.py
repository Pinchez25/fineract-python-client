...
class PagedLocalRequestAdvancedQueryRequest(BaseModel):
    """
    ...
    request: Optional[AdvancedQueryRequest] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "page": obj.get("page"),
            "request": AdvancedQueryRequest.from_dict(obj["request"]) if obj.get("request") is not None else None,
            "size": obj.get("size"),
