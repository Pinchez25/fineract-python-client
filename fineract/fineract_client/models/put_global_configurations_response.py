...
class PutGlobalConfigurationsResponse(BaseModel):
    """
    PutGlobalConfigurationsResponse
    """ # noqa: E501
    changes: Optional[PutGlobalConfigurationsResponsechangesSwagger] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": PutGlobalConfigurationsResponsechangesSwagger.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
