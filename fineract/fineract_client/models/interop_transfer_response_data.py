...
class InteropTransferResponseData(BaseModel):
    """
    ...
    completed_timestamp: Optional[StrictStr] = Field(default=None, alias="completedTimestamp")
    ...
    __properties: ClassVar[List[str]] = ["changes", "clientId", "commandId", "completedTimestamp", "creditBureauReportData", "expiration", "extensionList", "glimId", "groupId", "gsimId", "loanId", "officeId", "productId", "resourceExternalId", "resourceId", "resourceIdentifier", "rollbackTransaction", "savingsId", "state", "subResourceExternalId", "subResourceId", "transactionCode", "transactionId", "transferCode"]
