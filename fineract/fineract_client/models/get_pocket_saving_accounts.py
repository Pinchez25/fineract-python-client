...
class GetPocketSavingAccounts(BaseModel):
    """
    ...
    pocket_id: Optional[StrictInt] = Field(default=None, alias="pocketId")
    __properties: ClassVar[List[str]] = ["accountId", "accountNumber", "accountType", "id", "pocketId"]
