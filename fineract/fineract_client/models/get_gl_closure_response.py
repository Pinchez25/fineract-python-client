...
class GetGlClosureResponse(BaseModel):
    """
    ...
    last_updated_date: Optional[date] = Field(default=None, alias="lastUpdatedDate")
    ...
    __properties: ClassVar[List[str]] = ["closingDate", "comments", "createdByUserId", "createdByUsername", "createdDate", "deleted", "id", "lastUpdatedByUserId", "lastUpdatedByUsername", "lastUpdatedDate", "officeId", "officeName"]
