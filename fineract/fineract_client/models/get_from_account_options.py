...
class GetFromAccountOptions(BaseModel):
    """
    ...
    account_type: Optional[GetAccountOptions] = Field(default=None, alias="accountType")
    ...
    __properties: ClassVar[List[str]] = ["accountId", "accountNo", "accountType", "clientId", "clientName", "officeId", "officeName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "accountType": GetAccountOptions.from_dict(obj["accountType"]) if obj.get("accountType") is not None else None,
