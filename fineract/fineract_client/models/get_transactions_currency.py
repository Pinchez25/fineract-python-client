...
class GetTransactionsCurrency(BaseModel):
    """
    ...
    is_multiples_of: Optional[StrictInt] = Field(default=None, alias="isMultiplesOf")
    name: Optional[StrictStr] = None
    name_code: Optional[StrictStr] = Field(default=None, alias="nameCode")
    __properties: ClassVar[List[str]] = ["code", "decimalPlaces", "displayLabel", "displaySymbol", "isMultiplesOf", "name", "nameCode"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "isMultiplesOf": obj.get("isMultiplesOf"),
            "name": obj.get("name"),
