...
class ColumnFilterData(BaseModel):
    ...
    filters: Optional[List[FilterData]] = None
    __properties: ClassVar[List[str]] = ["column", "filters"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "filters": [FilterData.from_dict(_item) for _item in obj["filters"]] if obj.get("filters") is not None else None
        })
        return _obj
