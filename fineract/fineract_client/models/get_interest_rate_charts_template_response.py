...
class GetInterestRateChartsTemplateResponse(BaseModel):
    """
    GetInterestRateChartsTemplateResponse
    """ # noqa: E501
    period_types: Optional[List[GetInterestRateChartsTemplatePeriodTypes]] = Field(default=None, alias="periodTypes")
    __properties: ClassVar[List[str]] = ["periodTypes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "periodTypes": [GetInterestRateChartsTemplatePeriodTypes.from_dict(_item) for _item in obj["periodTypes"]] if obj.get("periodTypes") is not None else None
        })
        return _obj
