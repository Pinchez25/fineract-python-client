...
class PutCentersCenterIdResponse(BaseModel):
    """
    PutCentersCenterIdResponse
    """ # noqa: E501
    changes: Optional[PutCentersChanges] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": PutCentersChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
