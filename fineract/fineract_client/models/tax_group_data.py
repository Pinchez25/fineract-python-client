...
class TaxGroupData(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "taxAssociations": [TaxGroupMappingsData.from_dict(_item) for _item in obj["taxAssociations"]] if obj.get("taxAssociations") is not None else None
        })
        return _obj
