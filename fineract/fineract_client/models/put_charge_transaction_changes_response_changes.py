...
class PutChargeTransactionChangesResponseChanges(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["amount", "date", "externalId", "feeChargesPortion", "id", "interestPortion", "outstandingLoanBalance", "penaltyChargesPortion", "principalPortion"]
