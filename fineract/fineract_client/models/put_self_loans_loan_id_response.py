...
class PutSelfLoansLoanIdResponse(BaseModel):
    """
    PutSelfLoansLoanIdResponse
    """ # noqa: E501
    changes: Optional[PutSelfLoansChanges] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": PutSelfLoansChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
