...
class PutRecurringDepositAccountsAccountIdResponse(BaseModel):
    """
    PutRecurringDepositAccountsAccountIdResponse
    """ # noqa: E501
    changes: Optional[PutRecurringDepositAccountsChanges] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": PutRecurringDepositAccountsChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
