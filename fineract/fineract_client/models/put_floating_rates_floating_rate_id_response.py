...
class PutFloatingRatesFloatingRateIdResponse(BaseModel):
    """
    PutFloatingRatesFloatingRateIdResponse
    """ # noqa: E501
    changes: Optional[PutFloatingRatesChanges] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": PutFloatingRatesChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
