...
class PutSavingsAccountsAccountIdResponse(BaseModel):
    """
    PutSavingsAccountsAccountIdResponse
    """ # noqa: E501
    changes: Optional[PutSavingsAccountsChanges] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": PutSavingsAccountsChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
