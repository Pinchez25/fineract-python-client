...
class TransactionDetails(BaseModel):
    ...
    TransactionDetails
    """ # noqa: E501
    note_data: Optional[GetResourceTypeResourceIdNotesResponse] = Field(default=None, alias="noteData")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "noteData": GetResourceTypeResourceIdNotesResponse.from_dict(obj["noteData"]) if obj.get("noteData") is not None else None,
            "paymentDetails": PaymentDetailData.from_dict(obj["paymentDetails"]) if obj.get("paymentDetails") is not None else None,
            "transactionId": obj.get("transactionId"),
            "transactionType": EnumOptionType.from_dict(obj["transactionType"]) if obj.get("transactionType") is not None else None
        })
        return _obj
