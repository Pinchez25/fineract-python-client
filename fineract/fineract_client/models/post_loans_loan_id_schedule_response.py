...
class PostLoansLoanIdScheduleResponse(BaseModel):
    """
    PostLoansLoanIdScheduleResponse
    """ # noqa: E501
    changes: Optional[PostLoanChanges] = None
    loan_id: Optional[StrictInt] = Field(default=None, alias="loanId")
    __properties: ClassVar[List[str]] = ["changes", "loanId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": PostLoanChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
