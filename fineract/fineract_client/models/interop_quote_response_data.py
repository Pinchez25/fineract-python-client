...
class InteropQuoteResponseData(BaseModel):
    """
    ...
    fsp_commission: Optional[MoneyData] = Field(default=None, alias="fspCommission")
    fsp_fee: Optional[MoneyData] = Field(default=None, alias="fspFee")
    ...
    __properties: ClassVar[List[str]] = ["changes", "clientId", "commandId", "creditBureauReportData", "expiration", "extensionList", "fspCommission", "fspFee", "glimId", "groupId", "gsimId", "loanId", "officeId", "productId", "quoteCode", "resourceExternalId", "resourceId", "resourceIdentifier", "rollbackTransaction", "savingsId", "state", "subResourceExternalId", "subResourceId", "transactionCode", "transactionId"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of fsp_commission
        if self.fsp_commission:
            _dict['fspCommission'] = self.fsp_commission.to_dict()
        # override the default output from pydantic by calling `to_dict()` of fsp_fee
        if self.fsp_fee:
            _dict['fspFee'] = self.fsp_fee.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fspCommission": MoneyData.from_dict(obj["fspCommission"]) if obj.get("fspCommission") is not None else None,
            "fspFee": MoneyData.from_dict(obj["fspFee"]) if obj.get("fspFee") is not None else None,
