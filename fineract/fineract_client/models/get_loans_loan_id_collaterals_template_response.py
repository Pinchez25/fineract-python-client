...
class GetLoansLoanIdCollateralsTemplateResponse(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "allowedCollateralTypes": [GetCollateralsTemplateAllowedTypes.from_dict(_item) for _item in obj["allowedCollateralTypes"]] if obj.get("allowedCollateralTypes") is not None else None
        })
        return _obj
