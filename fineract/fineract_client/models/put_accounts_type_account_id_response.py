...
class PutAccountsTypeAccountIdResponse(BaseModel):
    """
    PutAccountsTypeAccountIdResponse
    """ # noqa: E501
    changes: Optional[PutAccountsChanges] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": PutAccountsChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
