...
class PostReportMailingJobsRequest(BaseModel):
    """
    ...
    stretchy_report_id: Optional[StrictInt] = Field(default=None, alias="stretchyReportId")
    stretchy_report_param_map: Optional[StrictStr] = Field(default=None, alias="stretchyReportParamMap")
    __properties: ClassVar[List[str]] = ["dateFormat", "description", "emailMessage", "emailRecipients", "emailSubject", "isActive", "locale", "name", "recurrence", "startDateTime", "stretchyReportId", "stretchyReportParamMap"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "stretchyReportId": obj.get("stretchyReportId"),
