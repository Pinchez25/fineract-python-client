...
class GetClientsClientIdIdentifiersTemplateResponse(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "allowedDocumentTypes": [GetClientsAllowedDocumentTypes.from_dict(_item) for _item in obj["allowedDocumentTypes"]] if obj.get("allowedDocumentTypes") is not None else None
        })
        return _obj
