...
class GetSelfClientsClientIdAccountsResponse(BaseModel):
    """
    GetSelfClientsClientIdAccountsResponse
    """ # noqa: E501
    loan_accounts: Optional[List[GetSelfClientsLoanAccounts]] = Field(default=None, alias="loanAccounts")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "loanAccounts": [GetSelfClientsLoanAccounts.from_dict(_item) for _item in obj["loanAccounts"]] if obj.get("loanAccounts") is not None else None,
            "savingsAccounts": [GetSelfClientsSavingsAccounts.from_dict(_item) for _item in obj["savingsAccounts"]] if obj.get("savingsAccounts") is not None else None
        })
        return _obj
