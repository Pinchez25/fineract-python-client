...
class PostSelfLoansDatatables(BaseModel):
    """
    PostSelfLoansDatatables
    """ # noqa: E501
    data: Optional[PostSelfLoansData] = None
    registered_table_name: Optional[StrictStr] = Field(default=None, alias="registeredTableName")
    __properties: ClassVar[List[str]] = ["data", "registeredTableName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": PostSelfLoansData.from_dict(obj["data"]) if obj.get("data") is not None else None,
