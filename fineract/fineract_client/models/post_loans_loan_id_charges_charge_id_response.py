...
class PostLoansLoanIdChargesChargeIdResponse(BaseModel):
    """
    PostLoansLoanIdChargesChargeIdResponse
    """ # noqa: E501
    changes: Optional[PostLoansLoanIdChargesChargeIdChanges] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": PostLoansLoanIdChargesChargeIdChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
