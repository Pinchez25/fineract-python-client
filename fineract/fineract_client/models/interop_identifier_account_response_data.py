...
class InteropIdentifierAccountResponseData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["accountId", "changes", "clientId", "commandId", "creditBureauReportData", "glimId", "groupId", "gsimId", "loanId", "officeId", "productId", "resourceExternalId", "resourceId", "resourceIdentifier", "rollbackTransaction", "savingsId", "subResourceExternalId", "subResourceId", "transactionId"]
