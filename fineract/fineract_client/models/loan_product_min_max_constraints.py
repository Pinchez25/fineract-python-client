...
class LoanProductMinMaxConstraints(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["maxNominalInterestRatePerPeriod", "maxNumberOfRepayments", "maxPrincipal", "minNominalInterestRatePerPeriod", "minNumberOfRepayments", "minPrincipal"]
