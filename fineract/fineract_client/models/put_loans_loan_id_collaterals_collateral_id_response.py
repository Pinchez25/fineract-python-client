...
class PutLoansLoanIdCollateralsCollateralIdResponse(BaseModel):
    """
    PutLoansLoanIdCollateralsCollateralIdResponse
    """ # noqa: E501
    changes: Optional[PutLoansLoandIdCollateralsCollateralIdRequest] = None
    ...
    __properties: ClassVar[List[str]] = ["changes", "loanId", "resourceId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": PutLoansLoandIdCollateralsCollateralIdRequest.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
