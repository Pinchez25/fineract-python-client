...
class GetHookTemplateResponse(BaseModel):
    """
    GetHookTemplateResponse
    """ # noqa: E501
    groupings: Optional[List[Grouping]] = None
    templates: Optional[List[HookTemplateData]] = None
    __properties: ClassVar[List[str]] = ["groupings", "templates"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "groupings": [Grouping.from_dict(_item) for _item in obj["groupings"]] if obj.get("groupings") is not None else None,
            "templates": [HookTemplateData.from_dict(_item) for _item in obj["templates"]] if obj.get("templates") is not None else None
        })
        return _obj
