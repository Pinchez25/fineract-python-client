...
class RetrieveOneResponse(BaseModel):
    """
    GetStaffResponse
    """ # noqa: E501
    ...
    is_loan_officer: Optional[StrictBool] = Field(default=None, alias="isLoanOfficer")
    ...
    __properties: ClassVar[List[str]] = ["displayName", "externalId", "firstname", "id", "isActive", "isLoanOfficer", "joiningDate", "lastname", "officeId", "officeName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "isLoanOfficer": obj.get("isLoanOfficer"),
