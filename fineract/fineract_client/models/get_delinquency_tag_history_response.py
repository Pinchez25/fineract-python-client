...
class GetDelinquencyTagHistoryResponse(BaseModel):
    """
    GetDelinquencyTagHistoryResponse
    """ # noqa: E501
    added_on_date: Optional[date] = Field(default=None, alias="addedOnDate")
    delinquency_range: Optional[GetDelinquencyRangesResponse] = Field(default=None, alias="delinquencyRange")
    id: Optional[StrictInt] = None
    lifted_on_date: Optional[date] = Field(default=None, alias="liftedOnDate")
    loan_id: Optional[StrictInt] = Field(default=None, alias="loanId")
    __properties: ClassVar[List[str]] = ["addedOnDate", "delinquencyRange", "id", "liftedOnDate", "loanId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "liftedOnDate": obj.get("liftedOnDate"),
