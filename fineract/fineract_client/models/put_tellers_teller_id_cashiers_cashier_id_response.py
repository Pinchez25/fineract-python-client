...
class PutTellersTellerIdCashiersCashierIdResponse(BaseModel):
    """
    PutTellersTellerIdCashiersCashierIdResponse
    """ # noqa: E501
    changes: Optional[PutTellersTellerIdCashiersCashierIdResponseChanges] = None
    ...
    __properties: ClassVar[List[str]] = ["changes", "resourceId", "subResourceId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": PutTellersTellerIdCashiersCashierIdResponseChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
