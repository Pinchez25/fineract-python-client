...
class GetSavingsAccountsSavingsAccountIdChargesTemplateResponse(BaseModel):
    """
    ...
    charge_options: Optional[List[GetSavingsChargesOptions]] = Field(default=None, alias="chargeOptions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "chargeOptions": [GetSavingsChargesOptions.from_dict(_item) for _item in obj["chargeOptions"]] if obj.get("chargeOptions") is not None else None,
