...
class GetSavingsProductsExpenseAccountOptions(BaseModel):
    """
    ...
    type: Optional[GetSavingsProductsExpenseType] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "tagId": obj.get("tagId"),
            "type": GetSavingsProductsExpenseType.from_dict(obj["type"]) if obj.get("type") is not None else None,
