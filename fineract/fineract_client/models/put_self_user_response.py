...
class PutSelfUserResponse(BaseModel):
    """
    PutSelfUserResponse
    """ # noqa: E501
    changes: Optional[PutSelfUserChanges] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": PutSelfUserChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
