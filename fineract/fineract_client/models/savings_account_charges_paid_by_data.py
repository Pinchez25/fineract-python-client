...
class SavingsAccountChargesPaidByData(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of savings_account_charge_data
        if self.savings_account_charge_data:
            _dict['savingsAccountChargeData'] = self.savings_account_charge_data.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "savingsAccountChargeData": SavingsAccountChargeData.from_dict(obj["savingsAccountChargeData"]) if obj.get("savingsAccountChargeData") is not None else None
        })
        return _obj
