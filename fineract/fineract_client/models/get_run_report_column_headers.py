...
class GetRunReportColumnHeaders(BaseModel):
    """
    ...
    column_values: Optional[StrictStr] = Field(default=None, alias="columnValues")
    ...
    __properties: ClassVar[List[str]] = ["columnName", "columnType", "columnValues", "isColumnNullable", "isColumnPrimaryKey"]
