...
class ExternalAssetOwnerTransferChangesData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["ownerExternalId", "purchasePriceRatio", "settlementDate", "transferExternalId"]
