...
class GetInterestRateChartsResponse(BaseModel):
    """
    GetInterestRateChartsResponse
    """ # noqa: E501
    chart_slabs: Optional[List[GetInterestRateChartsChartSlabs]] = Field(default=None, alias="chartSlabs")
    ...
    __properties: ClassVar[List[str]] = ["chartSlabs", "fromDate", "id", "savingsProductId", "savingsProductName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "chartSlabs": [GetInterestRateChartsChartSlabs.from_dict(_item) for _item in obj["chartSlabs"]] if obj.get("chartSlabs") is not None else None,
