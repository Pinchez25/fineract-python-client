...
class GetLoanAccountLockResponse(BaseModel):
    """
    GetLoanAccountLockResponse
    """ # noqa: E501
    content: Optional[List[LoanAccountLock]] = None
    limit: Optional[StrictInt] = None
    page: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["content", "limit", "page"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "content": [LoanAccountLock.from_dict(_item) for _item in obj["content"]] if obj.get("content") is not None else None,
            "limit": obj.get("limit"),
            "page": obj.get("page")
        })
        return _obj
