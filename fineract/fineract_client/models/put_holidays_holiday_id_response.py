...
class PutHolidaysHolidayIdResponse(BaseModel):
    """
    PutHolidaysHolidayIdResponse
    """ # noqa: E501
    changes: Optional[PutHolidaysHolidayIdResponseChanges] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": PutHolidaysHolidayIdResponseChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
