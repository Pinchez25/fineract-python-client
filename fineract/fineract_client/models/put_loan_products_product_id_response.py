...
class PutLoanProductsProductIdResponse(BaseModel):
    """
    PutLoanProductsProductIdResponse
    """ # noqa: E501
    changes: Optional[PutLoanChanges] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": PutLoanChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
