...
class GetChargesResponse(BaseModel):
    ...
    charge_applies_to: Optional[GetChargesAppliesToResponse] = Field(default=None, alias="chargeAppliesTo")
    charge_calculation_type: Optional[GetChargesCalculationTypeResponse] = Field(default=None, alias="chargeCalculationType")
    charge_payment_mode: Optional[GetChargesPaymentModeResponse] = Field(default=None, alias="chargePaymentMode")
    charge_time_type: Optional[GetChargesTimeTypeResponse] = Field(default=None, alias="chargeTimeType")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "chargeAppliesTo": GetChargesAppliesToResponse.from_dict(obj["chargeAppliesTo"]) if obj.get("chargeAppliesTo") is not None else None,
            "chargeCalculationType": GetChargesCalculationTypeResponse.from_dict(obj["chargeCalculationType"]) if obj.get("chargeCalculationType") is not None else None,
            "chargePaymentMode": GetChargesPaymentModeResponse.from_dict(obj["chargePaymentMode"]) if obj.get("chargePaymentMode") is not None else None,
            "chargeTimeType": GetChargesTimeTypeResponse.from_dict(obj["chargeTimeType"]) if obj.get("chargeTimeType") is not None else None,
