...
class GetLoansLoanIdTransactionsTemplateResponse(BaseModel):
    """
    ...
    total: Optional[GetLoansTotal] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "date": obj.get("date"),
            "total": GetLoansTotal.from_dict(obj["total"]) if obj.get("total") is not None else None,
            "transactionType": GetLoansTransactionType.from_dict(obj["transactionType"]) if obj.get("transactionType") is not None else None
        })
        return _obj
