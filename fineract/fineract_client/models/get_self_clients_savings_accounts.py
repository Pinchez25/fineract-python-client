...
class GetSelfClientsSavingsAccounts(BaseModel):
    """
    ...
    status: Optional[GetSelfClientsSavingsAccountsStatus] = None
    __properties: ClassVar[List[str]] = ["accountNo", "currency", "id", "productId", "productName", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "status": GetSelfClientsSavingsAccountsStatus.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj
