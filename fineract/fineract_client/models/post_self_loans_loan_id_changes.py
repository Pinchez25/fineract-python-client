...
class PostSelfLoansLoanIdChanges(BaseModel):
    """
    PostSelfLoansLoanIdChanges
    """ # noqa: E501
    closed_on_date: Optional[StrictStr] = Field(default=None, alias="closedOnDate")
    date_format: Optional[StrictStr] = Field(default=None, alias="dateFormat")
    locale: Optional[StrictStr] = None
    status: Optional[PostSelfLoansLoanIdStatus] = None
    withdrawn_on_date: Optional[StrictStr] = Field(default=None, alias="withdrawnOnDate")
    __properties: ClassVar[List[str]] = ["closedOnDate", "dateFormat", "locale", "status", "withdrawnOnDate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "status": PostSelfLoansLoanIdStatus.from_dict(obj["status"]) if obj.get("status") is not None else None,
