...
class GetSelfClientsClientIdTransactionsTransactionIdResponse(BaseModel):
    """
    ...
    type: Optional[GetSelfClientsClientIdTransactionsType] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": GetSelfClientsClientIdTransactionsType.from_dict(obj["type"]) if obj.get("type") is not None else None
        })
        return _obj
