...
class PostSavingsAccountBulkReversalTransactionsRequest(BaseModel):
    """
    PostSavingsAccountBulkReversalTransactionsRequest
    """ # noqa: E501
    is_bulk: Optional[StrictStr] = Field(default=None, alias="isBulk")
    __properties: ClassVar[List[str]] = ["isBulk"]
