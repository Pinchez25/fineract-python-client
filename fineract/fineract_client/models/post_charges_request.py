...
class PostChargesRequest(BaseModel):
    """
    PostChargesRequest
    """ # noqa: E501
    active: Optional[StrictBool] = None
    amount: Optional[Union[StrictFloat, StrictInt]] = None
    charge_applies_to: Optional[StrictInt] = Field(default=None, alias="chargeAppliesTo")
    charge_calculation_type: Optional[StrictInt] = Field(default=None, alias="chargeCalculationType")
    ...
    __properties: ClassVar[List[str]] = ["active", "amount", "chargeAppliesTo", "chargeCalculationType", "chargePaymentMode", "chargeTimeType", "currencyCode", "locale", "monthDayFormat", "name", "penalty"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "chargeAppliesTo": obj.get("chargeAppliesTo"),
            "chargeCalculationType": obj.get("chargeCalculationType"),
