...
class GetClientObligeeDetailsResponse(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "obligees": [GetObligeeData.from_dict(_item) for _item in obj["obligees"]] if obj.get("obligees") is not None else None
        })
        return _obj
