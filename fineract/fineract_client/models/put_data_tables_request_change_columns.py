...
class PutDataTablesRequestChangeColumns(BaseModel):
    """
    ...
    new_code: Optional[StrictStr] = Field(default=None, alias="newCode")
    new_name: Optional[StrictStr] = Field(default=None, alias="newName")
    unique: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["code", "indexed", "mandatory", "name", "newCode", "newName", "unique"]
