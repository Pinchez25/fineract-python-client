...
class GetSavingsPageItems(BaseModel):
    """
    GetSavingsPageItems
    """ # noqa: E501
    ...
    summary: Optional[GetSavingsSummary] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "summary": GetSavingsSummary.from_dict(obj["summary"]) if obj.get("summary") is not None else None,
