...
class GetAccountTransfersTemplateRefundByTransferFromAccount(BaseModel):
    """
    GetAccountTransfersTemplateRefundByTransferFromAccount
    """ # noqa: E501
    account_no: Optional[StrictInt] = Field(default=None, alias="accountNo")
    amt_for_transfer: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="amtForTransfer")
    ...
    __properties: ClassVar[List[str]] = ["accountNo", "amtForTransfer", "clientId", "clientName", "currency", "fieldOfficerId", "id", "productId", "productName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "amtForTransfer": obj.get("amtForTransfer"),
