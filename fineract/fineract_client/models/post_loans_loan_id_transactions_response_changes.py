...
class PostLoansLoanIdTransactionsResponseChanges(BaseModel):
    """
    ...
    transaction_amount: Optional[StrictStr] = Field(default=None, alias="transactionAmount")
    transaction_date: Optional[StrictStr] = Field(default=None, alias="transactionDate")
    __properties: ClassVar[List[str]] = ["dateFormat", "externalId", "locale", "note", "paymentTypeId", "reversalExternalId", "transactionAmount", "transactionDate"]
