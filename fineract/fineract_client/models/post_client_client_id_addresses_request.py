...
class PostClientClientIdAddressesRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["addressLine1", "addressLine2", "addressLine3", "city", "countryId", "isActive", "postalCode", "stateProvinceId", "street"]
