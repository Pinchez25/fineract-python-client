...
class PostRecurringDepositAccountsRecurringDepositAccountIdTransactionsTransactionIdResponse(BaseModel):
    """
    PostRecurringDepositAccountsRecurringDepositAccountIdTransactionsTransactionIdResponse
    """ # noqa: E501
    changes: Optional[PostRecurringChanges] = None
    ...
    __properties: ClassVar[List[str]] = ["changes", "clientId", "officeId", "resourceId", "savingsId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": PostRecurringChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
