...
class UpdatePostDatedCheckResponse(BaseModel):
    """
    UpdatePostDatedCheckResponse
    """ # noqa: E501
    changes: Optional[UpdateChangesResponse] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": UpdateChangesResponse.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
