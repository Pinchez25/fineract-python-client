...
class PostSavingsAccountsSavingsAccountIdChargesSavingsAccountChargeIdRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["amount", "dateFormat", "dueDate", "locale"]
