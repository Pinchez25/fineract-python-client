...
class GetAccountsSummary(BaseModel):
    """
    GetAccountsSummary
    """ # noqa: E501
    ...
    total_approved_shares: Optional[StrictInt] = Field(default=None, alias="totalApprovedShares")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "totalApprovedShares": obj.get("totalApprovedShares"),
            "totalPendingForApprovalShares": obj.get("totalPendingForApprovalShares")
        })
        return _obj
