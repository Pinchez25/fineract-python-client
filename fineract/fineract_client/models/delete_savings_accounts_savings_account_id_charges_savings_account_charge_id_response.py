...
class DeleteSavingsAccountsSavingsAccountIdChargesSavingsAccountChargeIdResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["clientId", "officeId", "resourceId", "savingsId"]
