...
class PostUpdateRescheduleLoansResponse(BaseModel):
    """
    PostUpdateRescheduleLoansResponse 
    """ # noqa: E501
    changes: Optional[PostUpdateRescheduleLoanChanges] = None
    ...
    __properties: ClassVar[List[str]] = ["changes", "clientId", "loanId", "officeId", "resourceId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": PostUpdateRescheduleLoanChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
