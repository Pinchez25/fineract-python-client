...
class GetTaxesGroupTaxAssociations(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "taxComponent": GetTaxesGroupTaxComponent.from_dict(obj["taxComponent"]) if obj.get("taxComponent") is not None else None
        })
        return _obj
