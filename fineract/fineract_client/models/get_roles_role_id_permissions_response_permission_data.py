...
class GetRolesRoleIdPermissionsResponsePermissionData(BaseModel):
    """
    ...
    grouping: Optional[StrictStr] = None
    selected: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["actionName", "code", "entityName", "grouping", "selected"]
