...
class InteropTransactionRequestResponseData(BaseModel):
    """
    ...
    request_code: StrictStr = Field(alias="requestCode")
    ...
    __properties: ClassVar[List[str]] = ["changes", "clientId", "commandId", "creditBureauReportData", "expiration", "extensionList", "glimId", "groupId", "gsimId", "loanId", "officeId", "productId", "requestCode", "resourceExternalId", "resourceId", "resourceIdentifier", "rollbackTransaction", "savingsId", "state", "subResourceExternalId", "subResourceId", "transactionCode", "transactionId"]
