...
class PutClientsClientIdIdentifiersIdentifierIdResponse(BaseModel):
    """
    PutClientsClientIdIdentifiersIdentifierIdResponse
    """ # noqa: E501
    changes: Optional[PutClientsClientIdIdentifiersIdentifierIdRequest] = None
    ...
    __properties: ClassVar[List[str]] = ["changes", "clientId", "officeId", "resourceId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": PutClientsClientIdIdentifiersIdentifierIdRequest.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
