...
class PutFinancialActivityAccountsResponse(BaseModel):
    """
    PutFinancialActivityAccountsResponse
    """ # noqa: E501
    comments: Optional[PutFinancialActivityAccountscommentsSwagger] = None
    resource_id: Optional[StrictInt] = Field(default=None, alias="resourceId")
    __properties: ClassVar[List[str]] = ["comments", "resourceId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "comments": PutFinancialActivityAccountscommentsSwagger.from_dict(obj["comments"]) if obj.get("comments") is not None else None,
