...
class PostHolidaysRequest(BaseModel):
    """
    PostHolidaysRequest
    """ # noqa: E501
    ...
    offices: Optional[List[PostHolidaysRequestOffices]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "offices": [PostHolidaysRequestOffices.from_dict(_item) for _item in obj["offices"]] if obj.get("offices") is not None else None,
