...
class PutSelfBeneficiariesTPTBeneficiaryIdResponse(BaseModel):
    """
    PutSelfBeneficiariesTPTBeneficiaryIdResponse
    """ # noqa: E501
    changes: Optional[PutSelfBeneficiariesChanges] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": PutSelfBeneficiariesChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
