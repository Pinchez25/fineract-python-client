...
class GetLoanProductsChargeOptions(BaseModel):
    """
    GetLoanProductsChargeOptions
    """ # noqa: E501
    active: Optional[StrictBool] = None
    amount: Optional[Union[StrictFloat, StrictInt]] = None
    charge_applies_to: Optional[GetLoanProductsChargeAppliesTo] = Field(default=None, alias="chargeAppliesTo")
    charge_calculation_type: Optional[GetLoanChargeCalculationType] = Field(default=None, alias="chargeCalculationType")
    charge_payment_mode: Optional[GetLoansChargePaymentMode] = Field(default=None, alias="chargePaymentMode")
    charge_time_type: Optional[GetLoanChargeTimeType] = Field(default=None, alias="chargeTimeType")
    currency: Optional[GetLoanProductsCurrencyOptions] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "chargeAppliesTo": GetLoanProductsChargeAppliesTo.from_dict(obj["chargeAppliesTo"]) if obj.get("chargeAppliesTo") is not None else None,
            "chargeCalculationType": GetLoanChargeCalculationType.from_dict(obj["chargeCalculationType"]) if obj.get("chargeCalculationType") is not None else None,
            "chargePaymentMode": GetLoansChargePaymentMode.from_dict(obj["chargePaymentMode"]) if obj.get("chargePaymentMode") is not None else None,
            "chargeTimeType": GetLoanChargeTimeType.from_dict(obj["chargeTimeType"]) if obj.get("chargeTimeType") is not None else None,
            "currency": GetLoanProductsCurrencyOptions.from_dict(obj["currency"]) if obj.get("currency") is not None else None,
            "id": obj.get("id"),
            "name": obj.get("name"),
