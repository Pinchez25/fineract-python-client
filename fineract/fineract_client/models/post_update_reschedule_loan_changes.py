...
class PostUpdateRescheduleLoanChanges(BaseModel):
    """
    PostUpdateRescheduleLoanChanges
    """ # noqa: E501
    approved_by_user_id: Optional[StrictInt] = Field(default=None, alias="approvedByUserId")
    ...
    __properties: ClassVar[List[str]] = ["approvedByUserId", "approvedOnDate", "dateFormat", "locale"]
