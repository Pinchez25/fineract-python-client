...
class PostAccountsTypeAccountIdRequest(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "requestedShares": [PostAccountsRequestedShares.from_dict(_item) for _item in obj["requestedShares"]] if obj.get("requestedShares") is not None else None
        })
        return _obj
