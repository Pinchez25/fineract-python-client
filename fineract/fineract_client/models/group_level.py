...
class GroupLevel(BaseModel):
    ...
    recursable: Optional[StrictBool] = None
    super_parent: Optional[StrictBool] = Field(default=None, alias="superParent")
    __properties: ClassVar[List[str]] = ["center", "group", "id", "levelName", "new", "parentId", "recursable", "superParent"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "recursable": obj.get("recursable"),
            "superParent": obj.get("superParent")
        })
        return _obj
