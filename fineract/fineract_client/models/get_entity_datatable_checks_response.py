...
class GetEntityDatatableChecksResponse(BaseModel):
    """
    GetEntityDatatableChecksResponse
    """ # noqa: E501
    datatable_name: Optional[StrictStr] = Field(default=None, alias="datatableName")
    ...
    __properties: ClassVar[List[str]] = ["datatableName", "entity", "id", "order", "productId", "productName", "status", "systemDefined"]
