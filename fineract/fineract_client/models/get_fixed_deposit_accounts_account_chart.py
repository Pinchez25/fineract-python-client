...
class GetFixedDepositAccountsAccountChart(BaseModel):
    """
    ...
    chart_slabs: Optional[List[GetFixedDepositAccountsChartSlabs]] = Field(default=None, alias="chartSlabs")
    from_date: Optional[date] = Field(default=None, alias="fromDate")
    id: Optional[StrictInt] = None
    period_types: Optional[List[GetFixedDepositAccountsPeriodTypes]] = Field(default=None, alias="periodTypes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "chartSlabs": [GetFixedDepositAccountsChartSlabs.from_dict(_item) for _item in obj["chartSlabs"]] if obj.get("chartSlabs") is not None else None,
            "fromDate": obj.get("fromDate"),
            "id": obj.get("id"),
            "periodTypes": [GetFixedDepositAccountsPeriodTypes.from_dict(_item) for _item in obj["periodTypes"]] if obj.get("periodTypes") is not None else None
        })
        return _obj
