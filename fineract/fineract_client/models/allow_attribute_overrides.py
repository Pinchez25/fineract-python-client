...
class AllowAttributeOverrides(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["amortizationType", "graceOnArrearsAgeing", "graceOnPrincipalAndInterestPayment", "inArrearsTolerance", "interestCalculationPeriodType", "interestType", "repaymentEvery", "transactionProcessingStrategyCode"]
