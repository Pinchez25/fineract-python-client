...
class GetFixedDepositProductsProductIdChartSlabs(BaseModel):
    """
    ...
    period_type: Optional[GetFixedDepositProductsProductIdPeriodType] = Field(default=None, alias="periodType")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "periodType": GetFixedDepositProductsProductIdPeriodType.from_dict(obj["periodType"]) if obj.get("periodType") is not None else None,
