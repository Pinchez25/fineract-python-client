...
class GetLoanProductsInterestRecalculationTemplateData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["interestRecalculationCompoundingType", "preClosureInterestCalculationStrategy", "rescheduleStrategyType"]
