...
class PutChargesChargeIdResponse(BaseModel):
    """
    PutChargesChargeIdResponse
    """ # noqa: E501
    changes: Optional[PutChargesChargeIdRequest] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": PutChargesChargeIdRequest.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
