...
class PostSelfBeneficiariesTPTRequest(BaseModel):
    """
    PostSelfBeneficiariesTPTRequest
    """ # noqa: E501
    account_number: Optional[StrictInt] = Field(default=None, alias="accountNumber")
    account_type: Optional[StrictInt] = Field(default=None, alias="accountType")
    ...
    __properties: ClassVar[List[str]] = ["accountNumber", "accountType", "locale", "name", "officeName", "transferLimit"]
