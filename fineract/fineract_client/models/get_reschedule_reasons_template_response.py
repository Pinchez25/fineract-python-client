...
class GetRescheduleReasonsTemplateResponse(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rescheduleReasons": [GetRescheduleReasonsAllowedTypes.from_dict(_item) for _item in obj["rescheduleReasons"]] if obj.get("rescheduleReasons") is not None else None
        })
        return _obj
