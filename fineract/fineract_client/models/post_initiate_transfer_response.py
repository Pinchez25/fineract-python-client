...
class PostInitiateTransferResponse(BaseModel):
    """
    PostInitiateTransferResponse
    """ # noqa: E501
    changes: Optional[ExternalAssetOwnerTransferChangesData] = None
    date_format: Optional[StrictStr] = Field(default=None, alias="dateFormat")
    locale: Optional[StrictStr] = None
    resource_external_id: Optional[StrictStr] = Field(default=None, description="transfer external ID", alias="resourceExternalId")
    resource_id: Optional[StrictInt] = Field(default=None, description="transfer ID", alias="resourceId")
    sub_resource_external_id: Optional[StrictStr] = Field(default=None, description="loan external ID", alias="subResourceExternalId")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": ExternalAssetOwnerTransferChangesData.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
            "dateFormat": obj.get("dateFormat"),
            "locale": obj.get("locale"),
            "resourceExternalId": obj.get("resourceExternalId"),
            "resourceId": obj.get("resourceId"),
            "subResourceExternalId": obj.get("subResourceExternalId"),
