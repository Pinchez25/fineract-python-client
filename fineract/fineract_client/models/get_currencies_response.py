...
class GetCurrenciesResponse(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "selectedCurrencyOptions": [CurrencyData.from_dict(_item) for _item in obj["selectedCurrencyOptions"]] if obj.get("selectedCurrencyOptions") is not None else None
        })
        return _obj
