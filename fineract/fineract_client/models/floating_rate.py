...
class FloatingRate(BaseModel):
    ...
    floating_rate_periods: Optional[List[FloatingRatePeriod]] = Field(default=None, alias="floatingRatePeriods")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "floatingRatePeriods": [FloatingRatePeriod.from_dict(_item) for _item in obj["floatingRatePeriods"]] if obj.get("floatingRatePeriods") is not None else None,
            "id": obj.get("id"),
...
FloatingRate.model_rebuild(raise_errors=False)
