...
class GetRecurringDepositAccountsTemplateResponse(BaseModel):
    """
    ...
    product_options: Optional[List[GetRecurringProductOptions]] = Field(default=None, alias="productOptions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "productOptions": [GetRecurringProductOptions.from_dict(_item) for _item in obj["productOptions"]] if obj.get("productOptions") is not None else None
        })
        return _obj
