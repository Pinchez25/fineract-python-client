...
class GetGroupsPageItems(BaseModel):
    """
    GetGroupsPageItems
    """ # noqa: E501
    ...
    status: Optional[GetGroupsStatus] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "status": GetGroupsStatus.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj
