...
class GetFromOfficeResponseStandingInstructionSwagger(BaseModel):
    """
    GetFromOfficeResponseStandingInstructionSwagger
    """ # noqa: E501
    decorated_name: Optional[StrictStr] = Field(default=None, alias="decoratedName")
    external_id: Optional[StrictStr] = Field(default=None, alias="externalId")
    hierarchy: Optional[StrictStr] = None
    id: Optional[StrictInt] = None
    name: Optional[StrictStr] = None
    opening_date: Optional[date] = Field(default=None, alias="openingDate")
    __properties: ClassVar[List[str]] = ["decoratedName", "externalId", "hierarchy", "id", "name", "openingDate"]
