...
class PutTaxesGroupTaxGroupIdRequest(BaseModel):
    """
    ...
    tax_components: Optional[List[PutTaxesGroupTaxComponents]] = Field(default=None, alias="taxComponents")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "taxComponents": [PutTaxesGroupTaxComponents.from_dict(_item) for _item in obj["taxComponents"]] if obj.get("taxComponents") is not None else None
        })
        return _obj
