...
class PutRolesRoleIdResponse(BaseModel):
    """
    PutRolesRoleIdResponse
    """ # noqa: E501
    changes: Optional[PutRolesRoleIdResponseChanges] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": PutRolesRoleIdResponseChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
