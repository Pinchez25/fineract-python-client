...
class PutUsersUserIdResponse(BaseModel):
    """
    PutUsersUserIdResponse
    """ # noqa: E501
    changes: Optional[PutUsersUserIdResponseChanges] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": PutUsersUserIdResponseChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
