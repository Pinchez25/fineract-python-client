...
class DelinquencyBucket(BaseModel):
    ...
    ranges: Optional[List[DelinquencyRange]] = None
    version: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["createdBy", "createdDate", "createdDateTime", "id", "lastModifiedBy", "lastModifiedDate", "lastModifiedDateTime", "name", "new", "ranges", "version"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "new": obj.get("new"),
            "ranges": [DelinquencyRange.from_dict(_item) for _item in obj["ranges"]] if obj.get("ranges") is not None else None,
