...
class GetFixedDepositAccountsTemplateResponse(BaseModel):
    """
    ...
    product_options: Optional[List[GetFixedDepositAccountsProductOptions]] = Field(default=None, alias="productOptions")
    __properties: ClassVar[List[str]] = ["clientId", "clientName", "productOptions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "productOptions": [GetFixedDepositAccountsProductOptions.from_dict(_item) for _item in obj["productOptions"]] if obj.get("productOptions") is not None else None
        })
        return _obj
