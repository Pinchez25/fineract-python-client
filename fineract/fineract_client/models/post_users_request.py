...
class PostUsersRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["clients", "email", "firstname", "isSelfServiceUser", "lastname", "officeId", "password", "passwordNeverExpires", "repeatPassword", "roles", "sendPasswordToEmail", "staffId", "username"]
