...
class PutReportMailingJobsResponse(BaseModel):
    """
    PutReportMailingJobsResponse
    """ # noqa: E501
    changes: Optional[PutReportMailingJobsResponseChanges] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": PutReportMailingJobsResponseChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
