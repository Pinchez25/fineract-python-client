...
class PutReportResponse(BaseModel):
    """
    PutReportResponse
    """ # noqa: E501
    changes: Optional[PutReportResponseChanges] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": PutReportResponseChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
