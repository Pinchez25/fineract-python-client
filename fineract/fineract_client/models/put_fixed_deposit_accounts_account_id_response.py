...
class PutFixedDepositAccountsAccountIdResponse(BaseModel):
    """
    PutFixedDepositAccountsAccountIdResponse
    """ # noqa: E501
    changes: Optional[PutFixedDepositAccountsChanges] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": PutFixedDepositAccountsChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
