...
class PostRecurringDepositProductsCharts(BaseModel):
    """
    PostRecurringDepositProductsCharts
    """ # noqa: E501
    chart_slabs: Optional[List[PostRecurringDepositProductsChartSlabs]] = Field(default=None, alias="chartSlabs")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "chartSlabs": [PostRecurringDepositProductsChartSlabs.from_dict(_item) for _item in obj["chartSlabs"]] if obj.get("chartSlabs") is not None else None,
