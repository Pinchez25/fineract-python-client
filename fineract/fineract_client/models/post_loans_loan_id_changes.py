...
class PostLoansLoanIdChanges(BaseModel):
    """
    ...
    status: Optional[PostLoansLoanIdStatus] = None
    __properties: ClassVar[List[str]] = ["approvedOnDate", "dateFormat", "locale", "note", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "note": obj.get("note"),
            "status": PostLoansLoanIdStatus.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj
