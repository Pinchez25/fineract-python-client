...
class GetClientsChargesPageItems(BaseModel):
    """
    ...
    charge_calculation_type: Optional[GetClientChargeCalculationType] = Field(default=None, alias="chargeCalculationType")
    charge_id: Optional[StrictInt] = Field(default=None, alias="chargeId")
    charge_time_type: Optional[GetClientChargeTimeType] = Field(default=None, alias="chargeTimeType")
    client_id: Optional[StrictInt] = Field(default=None, alias="clientId")
    currency: Optional[GetClientChargeCurrency] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "chargeCalculationType": GetClientChargeCalculationType.from_dict(obj["chargeCalculationType"]) if obj.get("chargeCalculationType") is not None else None,
            "chargeId": obj.get("chargeId"),
            "chargeTimeType": GetClientChargeTimeType.from_dict(obj["chargeTimeType"]) if obj.get("chargeTimeType") is not None else None,
            "clientId": obj.get("clientId"),
            "currency": GetClientChargeCurrency.from_dict(obj["currency"]) if obj.get("currency") is not None else None,
