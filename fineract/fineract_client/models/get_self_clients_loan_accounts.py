...
class GetSelfClientsLoanAccounts(BaseModel):
    """
    ...
    loan_type: Optional[GetSelfClientsLoanAccountsType] = Field(default=None, alias="loanType")
    ...
    status: Optional[GetSelfClientsLoanAccountsStatus] = None
    __properties: ClassVar[List[str]] = ["accountNo", "externalId", "id", "loanCycle", "loanType", "productId", "productName", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "loanType": GetSelfClientsLoanAccountsType.from_dict(obj["loanType"]) if obj.get("loanType") is not None else None,
            "productId": obj.get("productId"),
            "productName": obj.get("productName"),
            "status": GetSelfClientsLoanAccountsStatus.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj
