...
class GetLoansLoanIdLoanInstallmentChargeData(BaseModel):
    """
    List of GetLoansLoanIdLoanInstallmentChargeData
    """ # noqa: E501
    amount: Optional[Union[StrictFloat, StrictInt]] = None
    amount_accrued: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="amountAccrued")
    amount_outstanding: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="amountOutstanding")
    amount_unrecognized: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="amountUnrecognized")
    ...
    __properties: ClassVar[List[str]] = ["amount", "amountAccrued", "amountOutstanding", "amountUnrecognized", "amountWaived", "dueDate", "installmentNumber", "paid", "waived"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "amountAccrued": obj.get("amountAccrued"),
            "amountOutstanding": obj.get("amountOutstanding"),
            "amountUnrecognized": obj.get("amountUnrecognized"),
